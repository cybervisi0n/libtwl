...
static u32 tmpUserGameInfoBuf[WM_SIZE_TEMP_USR_GAME_INFO_BUF /
...
WMErrCode WM_SetWEPKey(WMCallbackFunc callback, u16 wepmode,
                       const u16 *wepkey) {
  WMErrCode result;
...
WMErrCode WM_SetWEPKeyEx(WMCallbackFunc callback, u16 wepmode, u16 wepkeyid,
  ...
  result = WMi_SendCommand(WM_APIID_SET_WEPKEY_EX, 3, (u32)wepmode, (u32)wepkey,
                           (u32)wepkeyid);
  WM_CHECK_RESULT(result);
...
WMErrCode WM_SetGameInfo(WMCallbackFunc callback, const u16 *userGameInfo,
  ...
  MI_CpuCopy16((void *)userGameInfo, (void *)tmpUserGameInfoBuf,
               userGameInfoSize);
  ...
  result =
      WMi_SendCommand(WM_APIID_SET_GAMEINFO, 5, (u32)tmpUserGameInfoBuf,
...
WMErrCode WM_SetLifeTime(WMCallbackFunc callback, u16 tableNumber,
  ...
  result =
      WMi_SendCommand(WM_APIID_SET_LIFETIME, 4, (u32)tableNumber,
