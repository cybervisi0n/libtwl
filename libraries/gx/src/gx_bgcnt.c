...
void *G2S_GetBG0ScrPtr(void) {
  int baseBlock =
      0x800 * ((reg_G2S_DB_BG0CNT & REG_G2S_DB_BG0CNT_SCREENBASE_MASK) >>
...
void *G2S_GetBG1ScrPtr(void) {
  int baseBlock =
      0x800 * ((reg_G2S_DB_BG1CNT & REG_G2S_DB_BG1CNT_SCREENBASE_MASK) >>
...
void *G2_GetBG2ScrPtr(void) {
  ...
  u32 blockID =
      (bg & REG_G2_BG2CNT_SCREENBASE_MASK) >> REG_G2_BG2CNT_SCREENBASE_SHIFT;
...
void *G2S_GetBG2ScrPtr(void) {
  GXBGMode bgMode =
      (GXBGMode)((reg_GXS_DB_DISPCNT & REG_GXS_DB_DISPCNT_BGMODE_MASK) >>
                 REG_GXS_DB_DISPCNT_BGMODE_SHIFT);
  u32 bg = reg_G2S_DB_BG2CNT;
  u32 blockID = (bg & REG_G2S_DB_BG2CNT_SCREENBASE_MASK) >>
...
void *G2_GetBG3ScrPtr(void) {
  ...
  int offset = getBGScreenOffset_();
  u32 blockID =
      (bg & REG_G2_BG3CNT_SCREENBASE_MASK) >> REG_G2_BG3CNT_SCREENBASE_SHIFT;
...
void *G2S_GetBG0CharPtr(void) {
  int baseBlock =
      0x4000 * ((reg_G2S_DB_BG0CNT & REG_G2S_DB_BG0CNT_CHARBASE_MASK) >>
...
void *G2S_GetBG1CharPtr(void) {
  int baseBlock =
      0x4000 * ((reg_G2S_DB_BG1CNT & REG_G2S_DB_BG1CNT_CHARBASE_MASK) >>
...
void *G2_GetBG2CharPtr(void) {
  ...
  if (bgMode < 5 || !(bg & REG_G2_BG2CNT_COLORMODE_MASK)) {
    ...
    u32 blockID =
        (bg & REG_G2_BG2CNT_CHARBASE_MASK) >> REG_G2_BG2CNT_CHARBASE_SHIFT;
...
void *G2S_GetBG2CharPtr(void) {
  ...
  if (bgMode < 5 || !(bg & REG_G2S_DB_BG2CNT_COLORMODE_MASK)) {
    ...
    u32 blockID = (bg & REG_G2S_DB_BG2CNT_CHARBASE_MASK) >>
...
void *G2_GetBG3CharPtr(void) {
  ...
  if (bgMode < 3 || (bgMode < 6 && !(bg & REG_G2_BG2CNT_COLORMODE_MASK))) {
    ...
    u32 blockID =
        (bg & REG_G2_BG3CNT_CHARBASE_MASK) >> REG_G2_BG3CNT_CHARBASE_SHIFT;
    int offset = getBGCharOffset_();
