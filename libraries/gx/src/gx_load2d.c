...
void GX_BeginLoadBGExtPltt() {
  SDK_ASSERT(0 == sBGExtPltt && 0 == sBGExtPlttLCDCBlk &&
             0 == sBGExtPlttLCDCOffset);
...
void GX_LoadBGExtPltt(const void *pSrc, u32 destSlotAddr, u32 szByte) {
  ...
  case GX_VRAM_BGEXTPLTT_0123_FG:
    SDK_TASSERTMSG(destSlotAddr + szByte <= 0x8000,
                   "Illegal address/size specified(0x%5x->0x%5x)", destSlotAddr,
                   destSlotAddr + szByte);
    break;
  ...
  GXi_DmaCopy32Async(
      GXi_DmaId, pSrc,
      (void *)(sBGExtPlttLCDCBlk + destSlotAddr - sBGExtPlttLCDCOffset), szByte,
      NULL, NULL);
}
...
void GX_LoadOBJExtPltt(const void *pSrc, u32 destSlotAddr, u32 szByte) {
  ...
  GXi_DmaCopy32Async(GXi_DmaId, pSrc,
                     (void *)(sOBJExtPlttLCDCBlk + destSlotAddr), szByte, NULL,
                     NULL);
}
...
void GXS_BeginLoadBGExtPltt() {
  ...
  SDK_TASSERTMSG(GX_VRAM_SUB_BGEXTPLTT_0123_H == sSubBGExtPltt,
                 "Sub BGExtPltt not allocated");
}
...
void GXS_LoadBGExtPltt(const void *pSrc, u32 destSlotAddr, u32 szByte) {
  ...
  GXi_DmaCopy32Async(GXi_DmaId, pSrc, (void *)(HW_LCDC_VRAM_H + destSlotAddr),
                     szByte, NULL, NULL);
}
...
void GXS_BeginLoadOBJExtPltt() {
  ...
  SDK_TASSERTMSG(GX_VRAM_SUB_OBJEXTPLTT_0_I == sSubOBJExtPltt,
                 "Sub OBJExtPltt not allocated");
}
...
void GXS_LoadOBJExtPltt(const void *pSrc, u32 destSlotAddr, u32 szByte) {
  ...
  GXi_DmaCopy32Async(GXi_DmaId, pSrc, (void *)(HW_LCDC_VRAM_I + destSlotAddr),
                     szByte, NULL, NULL);
}
