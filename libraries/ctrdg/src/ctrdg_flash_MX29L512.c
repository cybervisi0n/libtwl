...
extern void CTRDGi_WriteFlashSectorAsyncLE(u16 secNo, u8 *src,
...
void CTRDGi_WriteFlashSectorAsyncMX5(u16 secNo, u8 *src,
                                     CTRDG_TASK_FUNC callback);
...
const CTRDGiFlashTypePlus MN63F805MNP = {
    ...
    PaMaxTime,
    {
        ...
        {MI_CTRDG_RAMCYCLE_10,
         MI_CTRDG_RAMCYCLE_6}, // agb read cycle=4, write cycle=2
        0x32,                  // Maker ID
        0x1b,                  // Device ID
    },
};
