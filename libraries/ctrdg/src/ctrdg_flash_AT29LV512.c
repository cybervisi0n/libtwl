...
void CTRDGi_WriteFlashSectorAsyncAT(u16 secNo, u8 *src,
...
const CTRDGiFlashTypePlus AT29LV512_lib = {
    ...
    atMaxTime,
    {
        ...
        {MI_CTRDG_RAMCYCLE_18,
         MI_CTRDG_RAMCYCLE_18}, // agb read cycle=8, write cycle=8
        0x1f,                   // Maker ID
        0x3d,                   // Device ID
    },
};
...
const CTRDGiFlashTypePlus AT29LV512_org = {
    CTRDGi_WriteFlashSectorAT, // Unusable due to DataPolling routines not being
                               // transferred
    CTRDGi_EraseFlashChipAT,
    CTRDGi_EraseFlashSectorAT, // Unusable due to DataPolling routines not being
                               // transferred
...
u32 CTRDGi_EraseFlashChipCoreAT(CTRDGTaskInfo *arg) {
  ...
  *(vu8 *)CTRDG_BACKUP_COM_ADR1 = 0x10;
  ...
  result = CTRDGi_PollingSR(CTRDG_BACKUP_PHASE_CHIP_ERASE,
                            (u8 *)CTRDG_AGB_FLASH_ADR, 0xff);
...
u32 CTRDGi_EraseFlashSectorCoreAT(CTRDGTaskInfo *arg) {
  ...
  dst = (u8 *)(CTRDG_AGB_FLASH_ADR +
               (p_secNo << AT29LV512_org.type.sector.shift));
...
void CTRDGi_WriteFlash4KBAsyncAT(u16 l_secNo, u8 *src,
                                 CTRDG_TASK_FUNC callback) {
  CTRDGTaskInfo p;
...
void CTRDGi_WriteFlashSectorAsyncAT(u16 p_secNo, u8 *src,
                                    CTRDG_TASK_FUNC callback) {
  CTRDGTaskInfo p;
