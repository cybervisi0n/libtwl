...
static STDResult STDi_ConvertStringSjisToUnicodeCore(
    u16 *dst, int *dst_len, const char *src, int *src_len,
    STDConvertUnicodeCallback callback) __attribute__((never_inline));
static STDResult STDi_ConvertStringUnicodeToSjisCore(
    char *dst, int *dst_len, const u16 *src, int *src_len,
    STDConvertSjisCallback callback) __attribute__((never_inline));
#endif
...
#if !defined(STD_UNICODE_STATIC_IMPLEMENTATION)
{
  ...
  if (STD_Unicode2SjisArray == NULL) {
    ...
    return STDi_ConvertStringSjisToUnicodeCore(dst, dst_len, src, src_len,
                                               callback);
  }
}
#include <twl/ltdmain_begin.h>
static STDResult
STDi_ConvertStringSjisToUnicodeCore(u16 *dst, int *dst_len, const char *src,
                                    int *src_len,
                                    STDConvertUnicodeCallback callback)
...
#if !defined(STD_UNICODE_STATIC_IMPLEMENTATION)
{
  ...
  if (STD_Unicode2SjisArray == NULL) {
    ...
    return STDi_ConvertStringUnicodeToSjisCore(dst, dst_len, src, src_len,
                                               callback);
  }
}
#include <twl/ltdmain_begin.h>
static STDResult
STDi_ConvertStringUnicodeToSjisCore(char *dst, int *dst_len, const u16 *src,
                                    int *src_len,
                                    STDConvertSjisCallback callback)
#endif // !defined(STD_UNICODE_STATIC_IMPLEMENTATION)
{
