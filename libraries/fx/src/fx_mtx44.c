...
asm void MTX_Identity44_(register MtxFx44 *pDst) {
  mov r2,
      ...
      {r1, r2, r3} stmia r0 !, {r1, r3} stmia r0 !, {r1, r2, r3} stmia r0 !,
      {r1, r3} stmia r0 !,
      {r1, r2}
...
asm void MTX_Copy44To33_(register const MtxFx44 *pSrc, register MtxFx33 *pDst) {
  ldmia r0 !, {r2 - r3, r12} add r0, r0, #4 stmia r1 !,
      {r2 - r3, r12}

  ldmia r0 !,
      {r2 - r3, r12} add r0, r0, #4 stmia r1 !,
      {r2 - r3, r12}
...
void MTX_TransApply44(const MtxFx44 *pSrc, MtxFx44 *pDst, fx32 x, fx32 y,
                      fx32 z) {
  ...
  }
  {
    ...
    pDst->_32 =
        pSrc->_32 + (fx32)((xx * pSrc->_02 + yy * pSrc->_12 + zz * pSrc->_22) >>
                           FX32_SHIFT);
    pDst->_33 =
        pSrc->_33 + (fx32)((xx * pSrc->_03 + yy * pSrc->_13 + zz * pSrc->_23) >>
                           FX32_SHIFT);
  }
}
...
#else
asm void MTX_Transpose44_(register const MtxFx44 *pSrc,
                          register MtxFx44 *pDst) {
  stmfd sp !,
      {r4 - r11}

  ldr r12,
      [ r0, #48 ] ldmia r0 !, {r2 - r11} stmia r1 !, {r2, r6, r10, r12} ldr r12,
      [ r0, #12 ] stmia r1 !,
      {r3, r7, r11, r12}

  ldmia r0,
      {r10 - r11} ldr r12, [ r0, #16 ] stmia r1 !,
      {r4, r8, r10, r12}
...
asm void MTX_Scale44_(register MtxFx44 *pDst, register fx32 x, register fx32 y,
                      register fx32 z) {
  stmia r0 !, {r1} mov r1, #0 str r2, [ r0, #16 ] mov r2, #0 stmia r0 !,
      {r1, r2} stmia r0 !, {r1, r2} add r0, r0, #4 stmia r0 !,
      {r1, r2} stmia r0 !, {r1, r2, r3} stmia r0 !, {r1, r2} mov r3, #1 lsl r3,
      r3, #12 stmia r0 !, {r1, r2} str r3, [ r0, #0 ] bx lr
}
#include <nitro/code32.h>
#endif

void MTX_ScaleApply44(const MtxFx44 *pSrc, MtxFx44 *pDst, fx32 x, fx32 y,
                      fx32 z) {
  fx64 v;
...
#else
#include <nitro/code16.h>
asm void MTX_RotX44_(register MtxFx44 *pDst, register fx32 sinVal,
                     register fx32 cosVal) {

  str r2, [ r0, #20 ] str r2, [ r0, #40 ] str r1, [ r0, #24 ] neg r1, r1 str r1,
      [ r0, #36 ]

      mov r1,
      #1 mov r2, #0 lsl r1, r1, #12 mov r3,
      #0

      stmia r0 !,
      {r1, r2, r3} stmia r0 !, {r2, r3} add r0, #8 stmia r0 !, {r2, r3} add r0,
      #8 stmia r0 !, {r2, r3} stmia r0 !, {r2, r3} str r1,
      [ r0, #0 ]
...
#include <nitro/code16.h>
asm void MTX_RotY44_(register MtxFx44 *pDst, register fx32 sinVal,
                     register fx32 cosVal) {
  str r2, [ r0, #0 ] str r2, [ r0, #40 ] str r1, [ r0, #32 ] neg r1, r1 str r1,
      [ r0, #8 ]
      ...
      str r2,
      [ r0, #4 ] add r0, #12 stmia r0 !, {r1, r2, r3} stmia r0 !,
      {r1, r2} str r2, [ r0, #4 ] add r0, #12 stmia r0 !, {r1, r2} stmia r0 !,
      {r1, r2, r3}
...
#include <nitro/code16.h>
asm void MTX_RotZ44_(register MtxFx44 *pDst, register fx32 sinVal,
                     register fx32 cosVal) {
  str r2, [ r0, #0 ] str r2, [ r0, #20 ] str r1, [ r0, #4 ] neg r1, r1 str r1,
      ...
      add r0,
      #8 stmia r0 !, {r1, r2} add r0, #8 stmia r0 !, {r1, r2} stmia r0 !,
      {r1, r2, r3} stmia r0 !, {r1, r2} stmia r0 !,
      {r1, r2, r3}
...
void MTX_RotAxis44(MtxFx44 *pDst, const VecFx32 *vec, fx32 sinVal,
                   fx32 cosVal) {
...
void MTX_Concat44(const MtxFx44 *a, const MtxFx44 *b, MtxFx44 *ab) {
  ...
  p->_01 = (fx32)(((fx64)x * b->_01 + (fx64)y * b->_11 + (fx64)z * b->_21 +
                   (fx64)w * b->_31) >>
                  FX32_SHIFT);
  p->_03 = (fx32)(((fx64)x * b->_03 + (fx64)y * b->_13 + (fx64)z * b->_23 +
                   (fx64)w * b->_33) >>
                  FX32_SHIFT);
  ...
  p->_02 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  ...
  p->_12 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  p->_11 = (fx32)(((fx64)x * b->_01 + (fx64)y * b->_11 + (fx64)z * b->_21 +
                   (fx64)w * b->_31) >>
                  FX32_SHIFT);
  p->_13 = (fx32)(((fx64)x * b->_03 + (fx64)y * b->_13 + (fx64)z * b->_23 +
                   (fx64)w * b->_33) >>
                  FX32_SHIFT);
  ...
  p->_10 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  ...
  p->_20 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  p->_21 = (fx32)(((fx64)x * b->_01 + (fx64)y * b->_11 + (fx64)z * b->_21 +
                   (fx64)w * b->_31) >>
                  FX32_SHIFT);
  p->_23 = (fx32)(((fx64)x * b->_03 + (fx64)y * b->_13 + (fx64)z * b->_23 +
                   (fx64)w * b->_33) >>
                  FX32_SHIFT);
  ...
  p->_22 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  ...
  p->_32 = (fx32)(((fx64)x * xx + (fx64)y * yy + (fx64)z * zz + (fx64)w * ww) >>
                  FX32_SHIFT);
  ...
  p->_30 = (fx32)(((fx64)x * b->_00 + (fx64)y * b->_10 + (fx64)z * b->_20 +
                   (fx64)w * b->_30) >>
                  FX32_SHIFT);
  p->_33 = (fx32)(((fx64)x * b->_03 + (fx64)y * b->_13 + (fx64)z * b->_23 +
                   (fx64)w * b->_33) >>
                  FX32_SHIFT);
...
void MTX_FrustumW(fx32 t, fx32 b, fx32 l, fx32 r, fx32 n, fx32 f, fx32 scaleW,
                  MtxFx44 *mtx) {
  fx64c inv1, inv2;
  fx32 dblN;
...
void MTX_PerspectiveW(fx32 fovySin, fx32 fovyCos, fx32 aspect, fx32 n, fx32 f,
                      fx32 scaleW, MtxFx44 *mtx) {
  fx32 one_tan;
  fx64 t;

  SDK_NULL_ASSERT(mtx);
  SDK_TASSERTMSG(fovySin > 0 && fovySin < FX32_ONE,
                 "G3_Perspective: sine of fovy out of range.");
  SDK_TASSERTMSG(fovyCos > -FX32_ONE && fovyCos < FX32_ONE,
                 "G3_Perspective: cosine of fovy out of range.");
...
void MTX_OrthoW(fx32 t, fx32 b, fx32 l, fx32 r, fx32 n, fx32 f, fx32 scaleW,
                MtxFx44 *mtx) {
