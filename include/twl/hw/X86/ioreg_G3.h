...
#define REG_G3_MTX_POP_FIELD(s, int)                                           \
  (u32)(((u32)(s) << REG_G3_MTX_POP_S_SHIFT) |                                 \
...
#define REG_G3_MTX_STORE_FIELD(index)                                          \
  (u32)(((u32)(index) << REG_G3_MTX_STORE_INDEX_SHIFT))
#endif
...
#define REG_G3_MTX_RESTORE_FIELD(index)                                        \
  (u32)(((u32)(index) << REG_G3_MTX_RESTORE_INDEX_SHIFT))
#endif
...
#define REG_G3_MTX_LOAD_4x4_FIELD(s, integer_m44, decimal_m44)                 \
  (u32)(((u32)(s) << REG_G3_MTX_LOAD_4x4_S_SHIFT) |                            \
...
#define REG_G3_MTX_LOAD_4x3_FIELD(s, integer_m43, decimal_m43)                 \
  (u32)(((u32)(s) << REG_G3_MTX_LOAD_4x3_S_SHIFT) |                            \
...
#define REG_G3_MTX_MULT_4x4_FIELD(s, integer_m44, decimal_m44)                 \
  (u32)(((u32)(s) << REG_G3_MTX_MULT_4x4_S_SHIFT) |                            \
...
#define REG_G3_MTX_MULT_4x3_FIELD(s, integer_m43, decimal_m43)                 \
  (u32)(((u32)(s) << REG_G3_MTX_MULT_4x3_S_SHIFT) |                            \
...
#define REG_G3_MTX_MULT_3x3_FIELD(s, integer_m33, decimal_m33)                 \
  (u32)(((u32)(s) << REG_G3_MTX_MULT_3x3_S_SHIFT) |                            \
...
#define REG_G3_COLOR_FIELD(blue, green, red)                                   \
  (u32)(((u32)(blue) << REG_G3_COLOR_BLUE_SHIFT) |                             \
...
#define REG_G3_NORMAL_FIELD(sz, nz, sy, ny, sx, nx)                            \
  (u32)(((u32)(sz) << REG_G3_NORMAL_SZ_SHIFT) |                                \
...
#ifndef SDK_ASM
#define REG_G3_TEXCOORD_FIELD(st, integer, decimal_t, ss, integer_s,           \
                              decimal_s)                                       \
  (u32)(((u32)(st) << REG_G3_TEXCOORD_ST_SHIFT) |                              \
...
#define REG_G3_VTX_16_FIELD(sy, int_y, decimal_y, sx, int_x, decimal_x)        \
  (u32)(((u32)(sy) << REG_G3_VTX_16_SY_SHIFT) |                                \
...
#ifndef SDK_ASM
#define REG_G3_VTX_10_FIELD(sz, int_z, decimal_z, sy, int_y, decimal_y, sx,    \
                            int_x, decimal_x)                                  \
  (u32)(((u32)(sz) << REG_G3_VTX_10_SZ_SHIFT) |                                \
...
#define REG_G3_VTX_XY_FIELD(sy, int_y, decimal_y, sx, int_x, decimal_x)        \
  (u32)(((u32)(sy) << REG_G3_VTX_XY_SY_SHIFT) |                                \
...
#define REG_G3_VTX_XZ_FIELD(sz, int_z, decimal_z, sx, int_x, decimal_x)        \
  (u32)(((u32)(sz) << REG_G3_VTX_XZ_SZ_SHIFT) |                                \
...
#define REG_G3_VTX_YZ_FIELD(sz, int_z, decimal_z, sy, int_y, decimal_y)        \
  (u32)(((u32)(sz) << REG_G3_VTX_YZ_SZ_SHIFT) |                                \
...
#define REG_G3_VTX_DIFF_FIELD(sz, decimal_z, sy, decimal_y, sx, decimal_x)     \
  (u32)(((u32)(sz) << REG_G3_VTX_DIFF_SZ_SHIFT) |                              \
...
#ifndef SDK_ASM
#define REG_G3_POLYGON_ATTR_FIELD(id, alpha, fe, dt, d1, fc, xl, fr, bk, pm,   \
                                  le)                                          \
  (u32)(((u32)(id) << REG_G3_POLYGON_ATTR_ID_SHIFT) |                          \
...
#ifndef SDK_ASM
#define REG_G3_TEXIMAGE_PARAM_FIELD(tgen, tr, texfmt, t_size, v_size, ft, fs,  \
                                    rt, rs, tex_addr)                          \
  (u32)(((u32)(tgen) << REG_G3_TEXIMAGE_PARAM_TGEN_SHIFT) |                    \
...
#define REG_G3_TEXPLTT_BASE_FIELD(pltt_base)                                   \
  (u32)(((u32)(pltt_base) << REG_G3_TEXPLTT_BASE_PLTT_BASE_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_G3_DIF_AMB_FIELD(ambient_blue, ambient_green, ambient_red, c,      \
                             diffuse_blue, diffuse_green, diffuse_red)         \
  (u32)(((u32)(ambient_blue) << REG_G3_DIF_AMB_AMBIENT_BLUE_SHIFT) |           \
...
#ifndef SDK_ASM
#define REG_G3_SPE_EMI_FIELD(emission_blue, emission_green, emission_red, s,   \
                             specular_blue, specular_green, specular_red)      \
  (u32)(((u32)(emission_blue) << REG_G3_SPE_EMI_EMISSION_BLUE_SHIFT) |         \
...
#ifndef SDK_ASM
#define REG_G3_LIGHT_VECTOR_FIELD(lnum, sz, decimal_z, sy, decimal_y, sx,      \
                                  decimal_x)                                   \
  (u32)(((u32)(lnum) << REG_G3_LIGHT_VECTOR_LNUM_SHIFT) |                      \
...
#define REG_G3_LIGHT_COLOR_FIELD(lnum, blue, green, red)                       \
  (u32)(((u32)(lnum) << REG_G3_LIGHT_COLOR_LNUM_SHIFT) |                       \
...
#define REG_G3_SHININESS_FIELD(shininess3, shininess2, shininess1, shininess0) \
  (u32)(((u32)(shininess3) << REG_G3_SHININESS_SHININESS3_SHIFT) |             \
...
#define REG_G3_BEGIN_VTXS_FIELD(type)                                          \
  (u32)(((u32)(type) << REG_G3_BEGIN_VTXS_TYPE_SHIFT))
#endif
...
#define REG_G3_SWAP_BUFFERS_FIELD(dp, xs)                                      \
  (u32)(((u32)(dp) << REG_G3_SWAP_BUFFERS_DP_SHIFT) |                          \
...
#define REG_G3_VIEWPORT_FIELD(integer_y2, integer_x2, integer_y1, integer_x1)  \
  (u32)(((u32)(integer_y2) << REG_G3_VIEWPORT_INTEGER_Y2_SHIFT) |              \
...
#define REG_G3_BOX_TEST_FIELD(sy, int_y, decimal_y, sx, int_x, decimal_x)      \
  (u32)(((u32)(sy) << REG_G3_BOX_TEST_SY_SHIFT) |                              \
...
#define REG_G3_POS_TEST_FIELD(sy, int_y, decimal_y, sx, int_x, decimal_x)      \
  (u32)(((u32)(sy) << REG_G3_POS_TEST_SY_SHIFT) |                              \
...
#define REG_G3_VEC_TEST_FIELD(sz, decimal_z, sy, decimal_y, sx, decimal_x)     \
  (u32)(((u32)(sz) << REG_G3_VEC_TEST_SZ_SHIFT) |                              \
