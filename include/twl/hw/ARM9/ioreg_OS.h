...
#ifndef SDK_ASM
#define REG_OS_IE_FIELD(nd3, nd2, nd1, nd0, mib, mcb, cam, dsp, dwe, dre, gf,  \
                        mia, mi, mca, mc, ifn, ife, a7, mcbdet, mcadet, i_d,   \
                        k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)         \
  (u32)(                                                                       \
...
#ifndef SDK_ASM
#define REG_OS_IF_FIELD(nd3, nd2, nd1, nd0, mib, mcb, cam, dsp, dwe, dre, gf,  \
                        mia, mi, mca, mc, ifn, ife, a7, mcbdet, mcadet, i_d,   \
                        k, d3, d2, d1, d0, t3, t2, t1, t0, ve, hb, vb)         \
  (u32)(                                                                       \
