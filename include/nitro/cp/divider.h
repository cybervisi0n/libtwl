...
#define CP_DIV_32_32BIT_MODE                                                   \
  (0UL << REG_CP_DIVCNT_MODE_SHIFT) // 32bit/32bit mode
#define CP_DIV_64_32BIT_MODE                                                   \
  (1UL << REG_CP_DIVCNT_MODE_SHIFT) // 64bit/32bit mode
#define CP_DIV_64_64BIT_MODE                                                   \
  (2UL << REG_CP_DIVCNT_MODE_SHIFT) // 64bit/64bit mode
