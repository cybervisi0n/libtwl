...
typedef int (*MIDeviceReadFunction)(void *userdata, void *buffer, u32 offset,
                                    u32 length);
typedef int (*MIDeviceWriteFunction)(void *userdata, const void *buffer,
...
void MI_InitDevice(MIDevice *device, void *userdata, MIDeviceReadFunction read,
                   MIDeviceWriteFunction write) {
...
PLATFORM_ATTRIBUTE_INLINE
int MI_WriteDevice(MIDevice *device, const void *buffer, u32 offset,
                   u32 length) {
