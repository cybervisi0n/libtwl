...
static inline void MIi_ReadCard(u32 dmaNo, const void *src, void *dst,
                                u32 size) {
  MIi_LockCard();
...
static inline BOOL MIi_TryWaitCard(void) { return CARD_TryWaitRomAsync(); }

static inline void MIi_WaitCard(void) { CARD_WaitRomAsync(); }
