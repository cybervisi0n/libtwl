...
static inline void MI_SetMainMemoryPriority(MIProcessor proc) {
  ...
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_EP_MASK) |
                          (proc << REG_MI_EXMEMCNT_EP_SHIFT));
}
#endif

static inline MIProcessor MI_GetMainMemoryPriority(void) {
  return (MIProcessor)((reg_MI_EXMEMCNT & REG_MI_EXMEMCNT_EP_MASK) >>
                       REG_MI_EXMEMCNT_EP_SHIFT);
}

#if defined(SDK_ARM9) || defined(SDK_PORT)
static inline void MIi_SetCardProcessor(MIProcessor proc) {
  MI_PROCESSOR_ASSERT(proc);
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_MP_MASK) |
                          (proc << REG_MI_EXMEMCNT_MP_SHIFT));
}
#endif

static inline MIProcessor MI_GetCardProcessor(void) {
  return (MIProcessor)((reg_MI_EXMEMCNT & REG_MI_EXMEMCNT_MP_MASK) >>
                       REG_MI_EXMEMCNT_MP_SHIFT);
}

#if defined(SDK_ARM9) || defined(SDK_PORT)
static inline void MIi_SetCartridgeProcessor(MIProcessor proc) {
  MI_PROCESSOR_ASSERT(proc);
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_CP_MASK) |
                          (proc << REG_MI_EXMEMCNT_CP_SHIFT));
}
#endif

static inline MIProcessor MI_GetCartridgeProcessor(void) {
  return (MIProcessor)((reg_MI_EXMEMCNT & REG_MI_EXMEMCNT_CP_MASK) >>
                       REG_MI_EXMEMCNT_CP_SHIFT);
}

static inline void MIi_SetPhiClock(MIiPhiClock clock) {
  MI_PHICLOCK_ASSERT(clock);
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_PHI_MASK) |
                          (clock << REG_MI_EXMEMCNT_PHI_SHIFT));
}
...
static inline void MI_SetCartridgeRomCycle1st(MICartridgeRomCycle1st c1) {
  ...
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_ROM1st_MASK) |
                          (c1 << REG_MI_EXMEMCNT_ROM1st_SHIFT));
}

static inline MICartridgeRomCycle1st MI_GetCartridgeRomCycle1st(void) {
  return (
      MICartridgeRomCycle1st)((reg_MI_EXMEMCNT & REG_MI_EXMEMCNT_ROM1st_MASK) >>
...
static inline void MI_SetCartridgeRomCycle2nd(MICartridgeRomCycle2nd c2) {
  ...
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_ROM2nd_MASK) |
                          (c2 << REG_MI_EXMEMCNT_ROM2nd_SHIFT));
}

static inline MICartridgeRomCycle2nd MI_GetCartridgeRomCycle2nd(void) {
  return (
      MICartridgeRomCycle2nd)((reg_MI_EXMEMCNT & REG_MI_EXMEMCNT_ROM2nd_MASK) >>
...
static inline void MI_SetCartridgeRamCycle(MICartridgeRamCycle c) {
  ...
  reg_MI_EXMEMCNT = (u16)((reg_MI_EXMEMCNT & ~REG_MI_EXMEMCNT_RAM_MASK) |
                          (c << REG_MI_EXMEMCNT_RAM_SHIFT));
}
