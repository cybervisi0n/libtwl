...
static inline void UTi_SetResult(UTiResult r) { UTi_Result = r; }
...
#define UT_AssertEq(ex1, ex2)                                                  \
  UTi_AssertEq(__FILE__, __LINE__, #ex1, (int)(ex1), #ex2, (int)(ex2))
#define UT_AssertNe(ex1, ex2)                                                  \
  UTi_AssertNe(__FILE__, __LINE__, #ex1, (int)(ex1), #ex2, (int)(ex2))

void UTi_AssertMemEq(const char *file, int line, const char *exp_str1,
                     const void *exp_ptr1, const char *exp_str2,
                     const void *exp_ptr2, int exp_len);
void UTi_AssertMemNe(const char *file, int line, const char *exp_str1,
                     const void *exp_ptr1, const char *exp_str2,
                     const void *exp_ptr2, int exp_len);

#define UT_AssertMemPtrEq(ex1, ex2, len)                                       \
  UTi_AssertMemEq(__FILE__, __LINE__, #ex1, (const void *)(ex1), #ex2,         \
                  (const void *)(ex2), (int)(len))
#define UT_AssertMemPtrNe(ex1, ex2, len)                                       \
  UTi_AssertMemNe(__FILE__, __LINE__, #ex1, (const void *)(ex1), #ex2,         \
                  (const void *)(ex2), (int)(len))
#define UT_AssertMemEq(ex1, ex2)                                               \
  UTi_AssertMemEq(__FILE__, __LINE__, #ex1, (const void *)&(ex1), #ex2,        \
                  (const void *)&(ex2), sizeof(ex1))
