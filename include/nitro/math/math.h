...
SDK_INLINE int MATH_IAbs(int a) { return (a < 0) ? -a : a; }
...
SDK_INLINE int MATH_IMin(int a, int b) { return (a <= b) ? a : b; }

#define MATH_MAX(a, b) (((a) >= (b)) ? (a) : (b))

SDK_INLINE int MATH_IMax(int a, int b) { return (a >= b) ? a : b; }
...
SDK_INLINE u32 MATH_GetLeastSignificantBit(u32 x) { return (u32)(x & -(s32)x); }
