...
#define MATH_CRC16_STANDARD_POLY                                               \
  0xa001 // Items that carry out bit inversion also invert generator
         // polynomials.
#define MATH_CRC16_STANDARD_INIT 0
#define MATH_CRC16_CCITT_POLY 0x1021
#define MATH_CRC16_CCITT_INIT 0xffff

#define MATH_CRC32_STANDARD_POLY                                               \
  0xedb88320 // Items that carry out bit inversion also invert generator
             // polynomials.
...
static inline void MATHi_CRC8UpdateRev(const MATHCRC8Table *table,
...
static inline void MATH_CRC8Update(const MATHCRC8Table *table,
                                   MATHCRC8Context *context, const void *input,
                                   u32 length) {
  MATHi_CRC8Update(table, context, input, length);
}
...
static inline void MATH_CRC16CCITTUpdate(const MATHCRC16Table *table,
...
static inline void MATH_CRC16Update(const MATHCRC16Table *table,
                                    MATHCRC16Context *context,
                                    const void *input, u32 length) {
...
static inline void MATH_CRC32Update(const MATHCRC32Table *table,
...
static inline void MATH_CRC32POSIXUpdate(const MATHCRC32Table *table,
                                         MATHCRC32Context *context,
                                         const void *input, u32 length) {
...
u16 MATH_CalcCRC16(const MATHCRC16Table *table, const void *data,
                   u32 dataLength);

u16 MATH_CalcCRC16CCITT(const MATHCRC16Table *table, const void *data,
                        u32 dataLength);

u32 MATH_CalcCRC32(const MATHCRC32Table *table, const void *data,
                   u32 dataLength);

u32 MATH_CalcCRC32POSIX(const MATHCRC32Table *table, const void *data,
                        u32 dataLength);
