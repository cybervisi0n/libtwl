...
typedef struct CTRDGFlashTypeTag {
  ...
  MICartridgeRamCycle
      agbWait[2]; /* AGB cartridge bus RAM region's read/write weight value */
...
extern void CTRDG_EraseAgbFlashSectorAsync(u16 sec_num,
                                           CTRDG_TASK_FUNC callback);

extern u16 CTRDG_WriteAgbFlashSector(u16 sec_num, u8 *src);
extern void CTRDG_WriteAgbFlashSectorAsync(u16 sec_num, u8 *src,
                                           CTRDG_TASK_FUNC callback);

extern u32 CTRDG_VerifyAgbFlash(u16 sec_num, u8 *src, u32 size);
extern void CTRDG_VerifyAgbFlashAsync(u16 sec_num, u8 *src, u32 size,
                                      CTRDG_TASK_FUNC callback);

extern u32 CTRDG_WriteAndVerifyAgbFlash(u16 sec_num, u8 *src, u32 verifysize);
extern void CTRDG_WriteAndVerifyAgbFlashAsync(u16 sec_num, u8 *src,
                                              u32 verifysize,
                                              CTRDG_TASK_FUNC callback);
