...
#define CTRDG_PXI_FIXLEN_DATA_MASK                                             \
  0x03ffffff // Data part for fixed-length continuous packets
#define CTRDG_PXI_FIXLEN_DATA_SHIFT 0
#define CTRDG_PXI_FLEXLEN_DATA_MASK                                            \
  0x01ffffff // Data part for variable-length continuous packets
#define CTRDG_PXI_FLEXLEN_DATA_SHIFT 0
#define CTRDG_PXI_FLEXLEN_CONTINUOUS_BIT                                       \
  0x02000000 // Transferring variable-length continuous packets
