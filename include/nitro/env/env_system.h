...
#define ENV_RESTYPE_OFFSET_STRING                                              \
  ((ENVType)(ENV_RESTYPE_OFFSET_MASK | ENV_RESTYPE_STRING)) // 0x101
#define ENV_RESTYPE_OFFSET_BINARY                                              \
  ((ENV_RESTYPE_OFFSET_MASK | ENV_RESTYPE_BINARY)) // 0x102
#define ENV_RESTYPE_OFFSET_S64                                                 \
  ((ENVType)(ENV_RESTYPE_OFFSET_MASK | ENV_RESTYPE_S64)) // 0x10a
#define ENV_RESTYPE_OFFSET_U64                                                 \
  ((ENVType)(ENV_RESTYPE_OFFSET_MASK | ENV_RESTYPE_U64)) // 0x10b
...
#define ENV_S64(X)                                                             \
  sizeof(u32), ENV_RESTYPE_S64, (void *)((X) & 0xffffffff),                    \
      ENVi_DUMMY_FOR_U64, sizeof(u32), ENVi_RESTYPE_U64HALF,                   \
      (void *)((X) >> 32)

#define ENV_U64(X)                                                             \
  sizeof(u32), ENV_RESTYPE_U64, (void *)((X) & 0xffffffff),                    \
      ENVi_DUMMY_FOR_U64, sizeof(u32), ENVi_RESTYPE_U64HALF,                   \
      (void *)((X) >> 32)
...
static inline char *ENV_GetResourceName(ENVResource *res) { return res->name; }
static inline u16 ENV_GetResourceLen(ENVResource *res) { return res->len; }
static inline ENVType ENV_GetResourceType(ENVResource *res) {
  return res->type;
}
static inline void *ENV_GetResourcePtr(ENVResource *res) { return res->ptr; }
...
extern void ENV_InsertResourceSet(ENVResource *standardResSet,
                                  ENVResource *resSet);
...
extern ENVResource *ENVi_SearchByMemberName(const char *memberName,
...
extern ENVResource *ENVi_SearchByFullName(const char *fullName,
                                          ENVResource **resSetPtr);
...
static inline BOOL ENV_GetStringAndLength(const char *name, char **retPtr,
                                          int *len) {
...
static inline BOOL ENV_GetBinaryAndSize(const char *name, void **retPtr,
                                        int *size) {
...
extern ENVResource *ENV_SearchByClass(ENVResourceIter *iter,
                                      const char *className);

extern ENVResource *ENV_SearchByMember(ENVResourceIter *iter,
                                       const char *memberName);

extern ENVResource *ENV_SearchByType(ENVResourceIter *iter, ENVType type);

extern ENVResource *ENV_SearchByPartialName(ENVResourceIter *iter,
...
static inline ENVResource *
ENV_GetLastResourceSetFromIter(ENVResourceIter *iter) {
  SDK_ASSERT(iter);
