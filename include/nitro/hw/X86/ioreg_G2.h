...
extern REGType32v
    s_reg_G2_BG0OFS; // PCPORT_NOTES: These have the same offset address
extern REGType16v
    s_reg_G2_BG0HOFS; // PCPORT_NOTES: These have the same offset address
...
#ifndef SDK_ASM
#define REG_G2_BG0CNT_FIELD(screensize, bgplttslot, screenbase, colormode,     \
                            mosaic, charbase, priority)                        \
  (u16)(((u32)(screensize) << REG_G2_BG0CNT_SCREENSIZE_SHIFT) |                \
...
#ifndef SDK_ASM
#define REG_G2_BG1CNT_FIELD(screensize, bgplttslot, screenbase, colormode,     \
                            mosaic, charbase, priority)                        \
  (u16)(((u32)(screensize) << REG_G2_BG1CNT_SCREENSIZE_SHIFT) |                \
...
#ifndef SDK_ASM
#define REG_G2_BG2CNT_FIELD(screensize, areaover, screenbase, colormode,       \
                            mosaic, charbase, priority)                        \
  (u16)(((u32)(screensize) << REG_G2_BG2CNT_SCREENSIZE_SHIFT) |                \
...
#ifndef SDK_ASM
#define REG_G2_BG3CNT_FIELD(screensize, areaover, screenbase, colormode,       \
                            mosaic, charbase, priority)                        \
  (u16)(((u32)(screensize) << REG_G2_BG3CNT_SCREENSIZE_SHIFT) |                \
...
#define REG_G2_BG0OFS_FIELD(voffset, hoffset)                                  \
  (u32)(((u32)(voffset) << REG_G2_BG0OFS_VOFFSET_SHIFT) |                      \
...
#define REG_G2_BG0HOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG0HOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG0VOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG0VOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG1OFS_FIELD(voffset, hoffset)                                  \
  (u32)(((u32)(voffset) << REG_G2_BG1OFS_VOFFSET_SHIFT) |                      \
...
#define REG_G2_BG1HOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG1HOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG1VOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG1VOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG2OFS_FIELD(voffset, hoffset)                                  \
  (u32)(((u32)(voffset) << REG_G2_BG2OFS_VOFFSET_SHIFT) |                      \
...
#define REG_G2_BG2HOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG2HOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG2VOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG2VOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG3OFS_FIELD(voffset, hoffset)                                  \
  (u32)(((u32)(voffset) << REG_G2_BG3OFS_VOFFSET_SHIFT) |                      \
...
#define REG_G2_BG3HOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG3HOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG3VOFS_FIELD(offset)                                           \
  (u16)(((u32)(offset) << REG_G2_BG3VOFS_OFFSET_SHIFT))
#endif
...
#define REG_G2_BG2PA_FIELD(s, integer_dx, decimal_dx)                          \
  (u16)(((u32)(s) << REG_G2_BG2PA_S_SHIFT) |                                   \
...
#define REG_G2_BG2PB_FIELD(s, integer_dmx, decimal_dmx)                        \
  (u16)(((u32)(s) << REG_G2_BG2PB_S_SHIFT) |                                   \
...
#define REG_G2_BG2PC_FIELD(s, integer_dy, decimal_dy)                          \
  (u16)(((u32)(s) << REG_G2_BG2PC_S_SHIFT) |                                   \
...
#define REG_G2_BG2PD_FIELD(s, integer_dmy, decimal_dmy)                        \
  (u16)(((u32)(s) << REG_G2_BG2PD_S_SHIFT) |                                   \
...
#define REG_G2_BG3PA_FIELD(s, integer_dx, decimal_dx)                          \
  (u16)(((u32)(s) << REG_G2_BG3PA_S_SHIFT) |                                   \
...
#define REG_G2_BG3PB_FIELD(s, integer_dmx, decimal_dmx)                        \
  (u16)(((u32)(s) << REG_G2_BG3PB_S_SHIFT) |                                   \
...
#define REG_G2_BG3PC_FIELD(s, integer_dy, decimal_dy)                          \
  (u16)(((u32)(s) << REG_G2_BG3PC_S_SHIFT) |                                   \
...
#define REG_G2_BG3PD_FIELD(s, integer_dmy, decimal_dmy)                        \
  (u16)(((u32)(s) << REG_G2_BG3PD_S_SHIFT) |                                   \
...
#define REG_G2_WIN0H_FIELD(leftx, rightx)                                      \
  (u16)(((u32)(leftx) << REG_G2_WIN0H_LEFTX_SHIFT) |                           \
...
#define REG_G2_WIN1H_FIELD(leftx, rightx)                                      \
  (u16)(((u32)(leftx) << REG_G2_WIN1H_LEFTX_SHIFT) |                           \
...
#define REG_G2_WIN0V_FIELD(upy, downy)                                         \
  (u16)(((u32)(upy) << REG_G2_WIN0V_UPY_SHIFT) |                               \
...
#define REG_G2_WIN1V_FIELD(upy, downy)                                         \
  (u16)(((u32)(upy) << REG_G2_WIN1V_UPY_SHIFT) |                               \
...
#define REG_G2_WININ_FIELD(win1in, win0in)                                     \
  (u16)(((u32)(win1in) << REG_G2_WININ_WIN1IN_SHIFT) |                         \
...
#define REG_G2_WINOUT_FIELD(objwinin, winout)                                  \
  (u16)(((u32)(objwinin) << REG_G2_WINOUT_OBJWININ_SHIFT) |                    \
...
#define REG_G2_MOSAIC_FIELD(objvsize, objhsize, bgvsize, bghsize)              \
  (u16)(((u32)(objvsize) << REG_G2_MOSAIC_OBJVSIZE_SHIFT) |                    \
...
#define REG_G2_BLDCNT_FIELD(plane2, effect, plane1)                            \
  (u16)(((u32)(plane2) << REG_G2_BLDCNT_PLANE2_SHIFT) |                        \
...
#define REG_G2_BLDALPHA_FIELD(evb, eva)                                        \
  (u16)(((u32)(evb) << REG_G2_BLDALPHA_EVB_SHIFT) |                            \
