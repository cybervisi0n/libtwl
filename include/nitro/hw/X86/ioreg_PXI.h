...
#define REG_PXI_SUBPINTF_FIELD(i, ireq, a9status, a7status)                    \
  (u16)(((u32)(i) << REG_PXI_SUBPINTF_I_SHIFT) |                               \
...
#ifndef SDK_ASM
#define REG_PXI_SUBP_FIFO_CNT_FIELD(e, err, recv_ri, recv_full, recv_emp,      \
                                    send_cl, send_ti, send_full, send_emp)     \
  (u16)(((u32)(e) << REG_PXI_SUBP_FIFO_CNT_E_SHIFT) |                          \
