...
#ifndef SDK_ASM
#define REG_GX_DISPCNT_FIELD(o, bg, bgscreenoffset, bgcharoffset, oh, exobj,   \
                             vram, mode, ow, w1, w0, display, blank, objmap,   \
                             bg02d3d, bgmode, objmap_ch, objmap_bm, exobj_ch,  \
                             exobj_bm)                                         \
  (u32)(((u32)(o) << REG_GX_DISPCNT_O_SHIFT) |                                 \
...
#define REG_GX_DISPSTAT_FIELD(vcounter, vqi, hbi, vbi, lyc, hblk, vblk)        \
  (u16)(((u32)(vcounter) << REG_GX_DISPSTAT_VCOUNTER_SHIFT) |                  \
...
#define REG_GX_VCOUNT_FIELD(vcounter)                                          \
  (u16)(((u32)(vcounter) << REG_GX_VCOUNT_VCOUNTER_SHIFT))
#endif
...
#ifndef SDK_ASM
#define REG_GX_DISPCAPCNT_FIELD(e, mod, cofs, srcb, srca, wsize, wofs, dest,   \
                                evb, eva)                                      \
  (u32)(((u32)(e) << REG_GX_DISPCAPCNT_E_SHIFT) |                              \
...
#define REG_GX_DISP_MMEM_FIFO_FIELD(even, odd)                                 \
  (u32)(((u32)(even) << REG_GX_DISP_MMEM_FIFO_EVEN_SHIFT) |                    \
...
#define REG_GX_DISP_MMEM_FIFO_L_FIELD(red, green, blue)                        \
  (u16)(((u32)(red) << REG_GX_DISP_MMEM_FIFO_L_RED_SHIFT) |                    \
...
#define REG_GX_DISP_MMEM_FIFO_H_FIELD(red, green, blue)                        \
  (u16)(((u32)(red) << REG_GX_DISP_MMEM_FIFO_H_RED_SHIFT) |                    \
...
#define REG_GX_MASTER_BRIGHT_FIELD(e_mod, e_value)                             \
  (u16)(((u32)(e_mod) << REG_GX_MASTER_BRIGHT_E_MOD_SHIFT) |                   \
...
#define REG_GX_TVOUTCNT_FIELD(command3, command2, command)                     \
  (u16)(((u32)(command3) << REG_GX_TVOUTCNT_COMMAND3_SHIFT) |                  \
...
#define REG_GX_VRAMCNT_A_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_A_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_B_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_B_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_C_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_C_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_D_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_D_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_E_FIELD(e, mst)                                         \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_E_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_F_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_F_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_G_FIELD(e, ofs, mst)                                    \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_G_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_WRAM_FIELD(bank)                                        \
  (u8)(((u32)(bank) << REG_GX_VRAMCNT_WRAM_BANK_SHIFT))
#endif
...
#define REG_GX_VRAMCNT_H_FIELD(e, mst)                                         \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_H_E_SHIFT) |                                \
...
#define REG_GX_VRAMCNT_I_FIELD(e, mst)                                         \
  (u8)(((u32)(e) << REG_GX_VRAMCNT_I_E_SHIFT) |                                \
...
#define REG_GX_POWCNT_FIELD(ge, re, e2dg, lcd, lcdb, e2dgb, dsel)              \
  (u16)(((u32)(ge) << REG_GX_POWCNT_GE_SHIFT) |                                \
