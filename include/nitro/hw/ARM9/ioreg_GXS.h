...
#ifndef SDK_ASM
#define REG_GXS_DB_DISPCNT_FIELD(o, bg, oh, exobj, mode, ow, w1, w0, display,  \
                                 blank, objmap, bgmode, objmap_ch, objmap_bm,  \
                                 exobj_ch)                                     \
  (u32)(((u32)(o) << REG_GXS_DB_DISPCNT_O_SHIFT) |                             \
...
#define REG_GXS_DB_MASTER_BRIGHT_FIELD(e_mod, e_value)                         \
  (u16)(((u32)(e_mod) << REG_GXS_DB_MASTER_BRIGHT_E_MOD_SHIFT) |               \
