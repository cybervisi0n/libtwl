...
#define HW_SYSTEM_CLOCK 33514000 // More accurately 33513982?
...
#define HW_C1_LD_INTERWORK_DISABLE                                             \
  0x00008000 // Disable interworking with Load instruction
#define HW_C1_CACHE_ROUND_ROBIN                                                \
  0x00004000 // Cache replacement algorithm, round robin (Worst time bit ratio
             // is stable)
#define HW_C1_CACHE_PSEUDO_RANDOM                                              \
  0x00000000 //                            Pseudo random
#define HW_C1_EXCEPT_VEC_UPPER                                                 \
  0x00002000 // Exception vector, High-order address (set to this)
...
#define HW_C7_ICACHE_PREFCHP_MASK                                              \
  0xffffffe0 //   Instruction cache prefetch address
