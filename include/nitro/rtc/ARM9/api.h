...
#define RTC_ALARM_ENABLE_WEEK                                                  \
  0x0001 // Use day of week setting in interrupt determination
#define RTC_ALARM_ENABLE_HOUR                                                  \
  0x0002 // Use hour setting in interrupt determination
#define RTC_ALARM_ENABLE_MINUTE                                                \
  0x0004 // Use minute setting in interrupt determination
#define RTC_ALARM_ENABLE_ALL                                                   \
  (RTC_ALARM_ENABLE_WEEK | RTC_ALARM_ENABLE_HOUR | RTC_ALARM_ENABLE_MINUTE)
