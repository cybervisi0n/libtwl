...
#define RTC_PXI_RESULT_BIT_MASK                                                \
  0x00008000 // Mask for portion indicating PXI's response
#define RTC_PXI_RESULT_MASK                                                    \
  0x000000ff // Mask for the portion that stores processing results
#define RTC_PXI_RESULT_SHIFT                                                   \
  0 // Position of storage portion of processing result
...
#define RTC_PXI_COMMAND_READ_ADJUST                                            \
  0x18 // Read frequency steady interrupt register
...
#define RTC_PXI_COMMAND_WRITE_ADJUST                                           \
  0x28 // Write to frequency steady interrupt register
#define RTC_PXI_COMMAND_WRITE_FREE 0x29 // Write to the free register
#define RTC_PXI_COMMAND_INTERRUPT                                              \
  0x30 // To notify that an alarm interrupt has occurred
...
typedef enum RTCPxiResult {
  ...
  RTC_PXI_RESULT_ILLEGAL_STATUS,  // Cannot perform processing because of RTC
                                  // status
