...
#define FX_DEG_TO_RAD(deg)                                                     \
  ((fx32)((FX64C_TWOPI_360 * (deg) + 0x80000000LL) >> 32))
#define FX_DEG_TO_IDX(deg)                                                     \
  ((u16)((FX64C_65536_360 * (deg) + 0x80000000000LL) >> 44))

#define FX_RAD_TO_DEG(rad)                                                     \
  ((fx32)((FX64C_360_TWOPI * (rad) + 0x80000000LL) >> 32))
#define FX_RAD_TO_IDX(rad)                                                     \
  ((u16)((FX64C_65536_TWOPI * (rad) + 0x80000000000LL) >> 44))

#define FX_IDX_TO_RAD(idx)                                                     \
  ((fx32)((FX64C_TWOPI_65536 * (idx) + 0x80000LL) >> 20))
