...
SDK_INLINE void CARD_ProgramAndVerifyFlashAsync(u32 dst, const void *src,
...
SDK_INLINE BOOL CARD_WriteAndVerifyFlashSector(u32 dst, const void *src,
                                               u32 len) {
  return CARD_WriteAndVerifyBackupSector(dst, src, len);
}

SDK_INLINE void CARD_WriteAndVerifyFlashSectorAsync(u32 dst, const void *src,
                                                    u32 len,
                                                    MIDmaCallback callback,
                                                    void *arg) {
