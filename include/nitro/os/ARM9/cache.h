...
static inline void DC_CleanAll(void) { DC_StoreAll(); }

static inline void DC_CleanAndInvalidateAll(void) { DC_FlushAll(); }

static inline void DC_CleanRange(const void *startAddr, u32 nBytes) {
  DC_StoreRange(startAddr, nBytes);
}

static inline void DC_CleanAndInvalidateRange(const void *startAddr,
                                              u32 nBytes) {
