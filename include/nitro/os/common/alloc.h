...
extern void *OS_InitAlloc(OSArenaId id, void *arenaStart, void *arenaEnd,
                          int maxHeaps);
...
extern void OS_AddToHeap(OSArenaId id, OSHeapHandle heap, void *start,
                         void *end);
...
extern u32 OSi_GetTotalAllocSize(OSArenaId id, OSHeapHandle heap,
                                 BOOL isHeadInclude);
...
extern void OS_ClearHeap(OSArenaId id, OSHeapHandle heap, void *start,
                         void *end);
