...
#define OS_FWarning(console, ...)                                              \
  OSi_FWarning((console), __FILE__, __LINE__, __VA_ARGS__);
#define OS_FPanic(console, ...)                                                \
  OSi_FPanic((console), __FILE__, __LINE__, __VA_ARGS__);
#define OS_TFWarning(console, ...)                                             \
  OSi_TFWarning((console), __FILE__, __LINE__, __VA_ARGS__);
#define OS_TFPanic(console, ...)                                               \
  OSi_TFPanic((console), __FILE__, __LINE__, __VA_ARGS__);
