...
#define OSi_COSTINFO_SIZEOF_HEADERPART                                         \
  (sizeof(OSFunctionCostInfo) - sizeof(OSFunctionCost))
...
#define OSi_STATISTICS_SIZEOF_HEADERPART                                       \
  (sizeof(OSFunctionCostStatisticsInfo) - sizeof(OSFunctionCostStatistics))
#define OSi_STATISTICS_LEAST_SIZE                                              \
  (OSi_STATISTICS_SIZEOF_HEADERPART + sizeof(OSFunctionCostStatistics))

#ifndef OS_NO_FUNCTIONCOST
void OS_InitFunctionCost(void *buf, u32 size);
#else
static inline void OS_InitFunctionCost(void *, u32) { /* do nothing */ }
#endif

#ifndef OS_NO_FUNCTIONCOST
int OS_CalcFunctionCostLines(u32 size);
#else
static inline int OS_CalcFunctionCostLines(u32) { return 0; }
#endif

#ifndef OS_NO_FUNCTIONCOST
u32 OS_CalcFunctionCostBufferSize(int lines);
#else
static inline u32 OS_CalcFunctionCostBufferSize(int) { return 0; }
#endif
...
#else
static inline void OS_ClearFunctionCostBuffer(void) { /* do nothing */ }
#endif

#ifndef OS_NO_FUNCTIONCOST
BOOL OS_EnableFunctionCost();
#else
static inline BOOL OS_EnableFunctionCost() { return FALSE; }
#endif

#ifndef OS_NO_FUNCTIONCOST
BOOL OS_DisableFunctionCost();
#else
static inline BOOL OS_DisableFunctionCost() { return FALSE; }
#endif

#ifndef OS_NO_FUNCTIONCOST
BOOL OS_RestoreFunctionCost(BOOL enable);
#else
static inline BOOL OS_RestoreFunctionCost(BOOL) { return FALSE; }
#endif

#ifndef OS_NO_FUNCTIONCOST
void OS_InitStatistics(void *statBuf, u32 size);
#else
static inline void OS_InitStatistics(void *, u32) { /* do nothing */ }
#endif

#ifndef OS_NO_FUNCTIONCOST
void OS_CalcThreadStatistics(void *statBuf, OSThread *thread);
#else
static inline void OS_CalcThreadStatistics(void *,
                                           OSThread *) { /* do nothing */ }
#endif
...
#else
static inline void OS_DumpStatistics(void *) { /* do nothing */ }
#endif
