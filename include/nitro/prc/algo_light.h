...
static inline void PRC_Init_Light(void) { PRC_Init_Common(); }

static inline u32
PRC_GetPrototypeDBBufferSize_Light(const PRCPrototypeList *prototypeList) {
...
static inline BOOL
PRC_InitPrototypeDB_Light(PRCPrototypeDB_Light *protoDB, void *buffer,
                          const PRCPrototypeList *prototypeList) {
  return PRC_InitPrototypeDB_Common(protoDB, buffer, prototypeList);
}

static inline BOOL
PRC_InitPrototypeDBEx_Light(PRCPrototypeDB_Light *protoDB, void *buffer,
...
static inline u32 PRC_GetInputPatternBufferSize_Light(int maxPointCount,
                                                      int maxStrokeCount) {
...
static inline BOOL
PRC_InitInputPatternEx_Light(PRCInputPattern_Light *pattern, void *buffer,
                             const PRCStrokes *strokes, int maxPointCount,
                             int maxStrokeCount,
                             const PRCInputPatternParam_Light *param) {
...
static inline u32
PRC_GetRecognitionBufferSize_Light(int maxPointCount, int maxStrokeCount,
                                   const PRCPrototypeDB_Light *protoDB) {
  return PRC_GetRecognitionBufferSizeEx_Light(maxPointCount, maxStrokeCount,
                                              protoDB, NULL);
}
...
PRC_GetRecognizedEntries_Light(PRCPrototypeEntry **resultEntries,
                               fx32 *resultScores, int numRanking, void *buffer,
                               const PRCInputPattern_Light *input,
                               const PRCPrototypeDB_Light *protoDB) {
  return PRC_GetRecognizedEntriesEx_Light(resultEntries, resultScores,
                                          numRanking, buffer, input, protoDB,
                                          PRC_KIND_ALL, NULL);
}

static inline fx32 PRC_GetRecognizedEntryEx_Light(
    PRCPrototypeEntry **resultEntry, void *buffer,
    const PRCInputPattern_Light *input, const PRCPrototypeDB_Light *protoDB,
    u32 kindMask, const PRCRecognizeParam_Light *param) {
  fx32 score;
  (void)PRC_GetRecognizedEntriesEx_Light(resultEntry, &score, 1, buffer, input,
                                         protoDB, kindMask, param);
  return score;
}

static inline fx32
PRC_GetRecognizedEntry_Light(PRCPrototypeEntry **resultEntry, void *buffer,
                             const PRCInputPattern_Light *input,
                             const PRCPrototypeDB_Light *protoDB) {
  return PRC_GetRecognizedEntryEx_Light(resultEntry, buffer, input, protoDB,
                                        PRC_KIND_ALL, NULL);
}

static inline void
PRC_GetInputPatternStrokes_Light(PRCStrokes *strokes,
                                 const PRCInputPattern_Light *input) {
...
static inline void PRC_Init(void) { PRC_Init_Light(); }
...
PRC_GetPrototypeDBBufferSizeEx(const PRCPrototypeList *prototypeList,
  ...
  return PRC_GetPrototypeDBBufferSizeEx_Light(prototypeList, kindMask,
                                              ignoreDisabledEntries, param);
}
...
static inline BOOL PRC_InitInputPattern(PRCInputPattern *pattern, void *buffer,
  ...
  return PRC_InitInputPattern_Light(pattern, buffer, strokes, maxPointCount,
                                    maxStrokeCount);
}
...
static inline BOOL PRC_InitInputPatternEx(PRCInputPattern *pattern,
  ...
  return PRC_InitInputPatternEx_Light(pattern, buffer, strokes, maxPointCount,
                                      maxStrokeCount, param);
}
...
PRC_GetRecognitionBufferSize(int maxPointCount, int maxStrokeCount,
                             const PRCPrototypeDB_Light *protoDB) {
  return PRC_GetRecognitionBufferSize_Light(maxPointCount, maxStrokeCount,
                                            protoDB);
}
...
static inline int PRC_GetRecognizedEntries(PRCPrototypeEntry **resultEntries,
                                           ...
                                           const PRCInputPattern *input,
                                           const PRCPrototypeDB *protoDB) {
  return PRC_GetRecognizedEntries_Light(resultEntries, resultScores, numRanking,
                                        buffer, input, protoDB);
}
