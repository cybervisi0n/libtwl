...
typedef enum {
  GX_OAM_SHAPE_8x8 =
      (0 << GX_OAM_ATTR01_SHAPE_SHIFT) | (0 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_16x16 =
      (0 << GX_OAM_ATTR01_SHAPE_SHIFT) | (1 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_32x32 =
      (0 << GX_OAM_ATTR01_SHAPE_SHIFT) | (2 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_64x64 =
      (0 << GX_OAM_ATTR01_SHAPE_SHIFT) | (3 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_16x8 =
      (1 << GX_OAM_ATTR01_SHAPE_SHIFT) | (0 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_32x8 =
      (1 << GX_OAM_ATTR01_SHAPE_SHIFT) | (1 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_32x16 =
      (1 << GX_OAM_ATTR01_SHAPE_SHIFT) | (2 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_64x32 =
      (1 << GX_OAM_ATTR01_SHAPE_SHIFT) | (3 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_8x16 =
      (2 << GX_OAM_ATTR01_SHAPE_SHIFT) | (0 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_8x32 =
      (2 << GX_OAM_ATTR01_SHAPE_SHIFT) | (1 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_16x32 =
      (2 << GX_OAM_ATTR01_SHAPE_SHIFT) | (2 << GX_OAM_ATTR01_SIZE_SHIFT),
  GX_OAM_SHAPE_32x64 =
      (2 << GX_OAM_ATTR01_SHAPE_SHIFT) | (3 << GX_OAM_ATTR01_SIZE_SHIFT)
} GXOamShape;

#define GX_OAM_SHAPE_ASSERT(x)                                                 \
  SDK_ASSERT((x) == GX_OAM_SHAPE_8x8 || (x) == GX_OAM_SHAPE_16x16 ||           \
             (x) == GX_OAM_SHAPE_32x32 || (x) == GX_OAM_SHAPE_64x64 ||         \
             (x) == GX_OAM_SHAPE_16x8 || (x) == GX_OAM_SHAPE_32x8 ||           \
             (x) == GX_OAM_SHAPE_32x16 || (x) == GX_OAM_SHAPE_64x32 ||         \
             (x) == GX_OAM_SHAPE_8x16 || (x) == GX_OAM_SHAPE_8x32 ||           \
             (x) == GX_OAM_SHAPE_16x32 || (x) == GX_OAM_SHAPE_32x64)
...
typedef enum {
  GX_OAM_EFFECT_NONE = (0 << GX_OAM_ATTR01_RSENABLE_SHIFT) |
                       (0 << GX_OAM_ATTR01_HF_SHIFT) |
                       (0 << GX_OAM_ATTR01_VF_SHIFT),
  GX_OAM_EFFECT_FLIP_H = (0 << GX_OAM_ATTR01_RSENABLE_SHIFT) |
                         (1 << GX_OAM_ATTR01_HF_SHIFT) |
                         (0 << GX_OAM_ATTR01_VF_SHIFT),
  GX_OAM_EFFECT_FLIP_V = (0 << GX_OAM_ATTR01_RSENABLE_SHIFT) |
                         (0 << GX_OAM_ATTR01_HF_SHIFT) |
                         (1 << GX_OAM_ATTR01_VF_SHIFT),
  GX_OAM_EFFECT_FLIP_HV = (0 << GX_OAM_ATTR01_RSENABLE_SHIFT) |
                          (1 << GX_OAM_ATTR01_HF_SHIFT) |
                          (1 << GX_OAM_ATTR01_VF_SHIFT),
...
#define GX_OAM_EFFECT_ASSERT(x)                                                \
  SDK_ASSERT((x) == GX_OAM_EFFECT_NONE || (x) == GX_OAM_EFFECT_FLIP_H ||       \
             (x) == GX_OAM_EFFECT_FLIP_V || (x) == GX_OAM_EFFECT_FLIP_HV ||    \
             (x) == GX_OAM_EFFECT_AFFINE || (x) == GX_OAM_EFFECT_NODISPLAY ||  \
...
#define GX_OAM_PRIORTY_ASSERT(x) SDK_MINMAX_ASSERT(x, 0, 3)
...
static void G2_SetOBJAttr(GXOamAttr *oam, int x, int y, int priority,
                          GXOamMode mode, BOOL mosaic, GXOamEffect effect,
                          GXOamShape shape, GXOamColorMode color, int charName,
                          int cParam, int rsParam);
...
static inline int G2_GetOBJPriority(const GXOamAttr *oam) {
  ...
  return (oam->attr2 & GX_OAM_ATTR2_PRIORITY_MASK) >>
         GX_OAM_ATTR2_PRIORITY_SHIFT;
}
...
static inline void G2_SetOBJMode(GXOamAttr *oam, GXOamMode mode, int cParam) {
  ...
  oam->attr01 = ((oam->attr01 & ~GX_OAM_ATTR01_MODE_MASK) |
...
static inline GXOamMode G2_GetOBJMode(const GXOamAttr *oam) {
  ...
  return (GXOamMode)((oam->attr01 & GX_OAM_ATTR01_MODE_MASK) >>
                     GX_OAM_ATTR01_MODE_SHIFT);
}
...
static inline void G2_SetOBJEffect(GXOamAttr *oam, GXOamEffect effect,
                                   int rsParam) {
...
static inline void G2_SetOBJShape(GXOamAttr *oam, GXOamShape shape) {
  ...
  oam->attr01 =
      ((oam->attr01 & ~(GX_OAM_ATTR01_SHAPE_MASK | GX_OAM_ATTR01_SIZE_MASK)) |
       shape);
}
...
static inline GXOamShape G2_GetOBJShape(const GXOamAttr *oam) {
  ...
  return (GXOamShape)(oam->attr01 &
                      (GX_OAM_ATTR01_SHAPE_MASK | GX_OAM_ATTR01_SIZE_MASK));
}
...
static inline void G2_SetOBJColorMode(GXOamAttr *oam, GXOamColorMode color) {
  ...
  oam->attr01 = ((oam->attr01 & ~GX_OAM_ATTR01_CM_MASK) |
                 (color << GX_OAM_ATTR01_CM_SHIFT));
}

static inline GXOamColorMode G2_GetOBJColorMode(const GXOamAttr *oam) {
  SDK_NULL_ASSERT(oam);

  return (GXOamColorMode)((oam->attr01 & GX_OAM_ATTR01_CM_MASK) >>
                          GX_OAM_ATTR01_CM_SHIFT);
}
...
static inline void G2_SetOBJAttr(GXOamAttr *oam, int x, int y, int priority,
                                 GXOamMode mode, BOOL mosaic,
                                 GXOamEffect effect, GXOamShape shape,
                                 GXOamColorMode color, int charName, int cParam,
                                 int rsParam) {
...
#define G2_SET_OBJ_ATTR_(af_t, bm_t)                                           \
  oam->attr01 =                                                                \
      (u32)(G2_SET_OBJ_ATTR_AFMODE_##af_t##_()                                 \
                G2_SET_OBJ_ATTR_CLMODE_##bm_t##_()(                            \
                    (y & (GX_OAM_ATTR01_Y_MASK >> GX_OAM_ATTR01_Y_SHIFT))      \
                    << GX_OAM_ATTR01_Y_SHIFT) |                                \
            (mode << GX_OAM_ATTR01_MODE_SHIFT) |                               \
            (mosaic << GX_OAM_ATTR01_MOSAIC_SHIFT) | shape |                   \
            ((x & (GX_OAM_ATTR01_X_MASK >> GX_OAM_ATTR01_X_SHIFT))             \
             << GX_OAM_ATTR01_X_SHIFT) |                                       \
            effect);
  ...
  SDK_WARNING(
      !(mode == GX_OAM_MODE_BITMAPOBJ && color == GX_OAM_COLORMODE_256),
      "Only GX_OAM_COLORMODE_16 can be specified with GX_OAM_MODE_BITMAPOBJ.");
