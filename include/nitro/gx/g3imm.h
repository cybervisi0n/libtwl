...
static void G3_PolygonAttr(int light, GXPolygonMode polyMode, GXCull cullMode,
                           int polygonID, int alpha,
                           int misc // GXPolygonAttrMisc
);
static void G3_TexImageParam(GXTexFmt texFmt, GXTexGen texGen, GXTexSizeS s,
                             GXTexSizeT t, GXTexRepeat repeat, GXTexFlip flip,
                             GXTexPlttColor0 pltt0, u32 addr);
static void G3_TexPlttBase(u32 addr, GXTexFmt texfmt);
static void G3_MaterialColorDiffAmb(GXRgb diffuse, GXRgb ambient,
                                    BOOL IsSetVtxColor);
static void G3_MaterialColorSpecEmi(GXRgb specular, GXRgb emission,
                                    BOOL IsShininess);
...
static inline void G3_PushMtx() { reg_G3_MTX_PUSH = 0; }
...
static inline void G3_Identity() { reg_G3_MTX_IDENTITY = 0; }
...
static inline void G3_PolygonAttr(int light, GXPolygonMode polyMode,
  ...
  reg_G3_POLYGON_ATTR = GX_PACK_POLYGONATTR_PARAM(light, polyMode, cullMode,
                                                  polygonID, alpha, misc);
}

static inline void G3_TexImageParam(GXTexFmt texFmt, GXTexGen texGen,
...
static inline void G3_MaterialColorDiffAmb(GXRgb diffuse, GXRgb ambient,
                                           BOOL IsSetVtxColor) {
...
static inline void G3_MaterialColorSpecEmi(GXRgb specular, GXRgb emission,
                                           BOOL IsShininess) {
...
static inline void G3_End() { reg_G3_END_VTXS = 0; }
