...
#define GX_BG_SCRSIZE_AFFINE_ASSERT(x)                                         \
  SDK_MINMAX_ASSERT(x, GX_BG_SCRSIZE_AFFINE_128x128,                           \
                    GX_BG_SCRSIZE_AFFINE_1024x1024)
...
#define GX_BG_SCRSIZE_256x16PLTT_ASSERT(x)                                     \
  SDK_MINMAX_ASSERT(x, GX_BG_SCRSIZE_256x16PLTT_128x128,                       \
...
#define GX_BG_SCRSIZE_256BMP_ASSERT(x)                                         \
  SDK_MINMAX_ASSERT(x, GX_BG_SCRSIZE_256BMP_128x128,                           \
                    GX_BG_SCRSIZE_256BMP_512x512)
...
#define GX_BG_SCRSIZE_LARGEBMP_ASSERT(x)                                       \
  SDK_MINMAX_ASSERT(x, GX_BG_SCRSIZE_LARGEBMP_512x1024,                        \
                    GX_BG_SCRSIZE_LARGEBMP_1024x512)
...
typedef enum { GX_BG_AREAOVER_XLU = 0, GX_BG_AREAOVER_REPEAT = 1 } GXBGAreaOver;
...
typedef enum { GX_BG_EXTPLTT_01 = 0, GX_BG_EXTPLTT_23 = 1 } GXBGExtPltt;
...
typedef enum {
  GX_BG_EXTMODE_256x16PLTT = (0 << REG_G2_BG2CNT_CHARBASE_SHIFT) |
                             (0 << REG_G2_BG2CNT_COLORMODE_SHIFT),
  GX_BG_EXTMODE_256BITMAP = (0 << REG_G2_BG2CNT_CHARBASE_SHIFT) |
                            (1 << REG_G2_BG2CNT_COLORMODE_SHIFT),
...
static void G2_SetBG2ControlLargeBmp(GXBGScrSizeLargeBmp screenSize,
                                     GXBGAreaOver areaOver);
...
static void *
G2S_GetOBJCharPtr(void); // fixed(always returns (void*)HW_DB_OBJ_VRAM)
...
#define GX_BGMODE_WARNING1(name, mode1)                                        \
  do {                                                                         \
    ...
    SDK_WARNING(tmp == mode1, #name##": BG mode should be %d", mode1);         \
    (void)0;                                                                   \
  } while (0)
...
#define GX_BGMODE_WARNING3(name, mode1, mode2, mode3)                          \
  do {                                                                         \
    ...
    SDK_WARNING(tmp == mode1 || tmp == mode2 || tmp == mode3,                  \
                #name##": BG mode should be %d, %d, or %d", mode1, mode2,      \
                mode3);                                                        \
    (void)0;                                                                   \
  } while (0)
...
static inline void G2S_SetBG0Control(GXBGScrSizeText screenSize,
  ...
  reg_G2S_DB_BG0CNT =
      (u16)((reg_G2S_DB_BG0CNT & (REG_G2S_DB_BG0CNT_PRIORITY_MASK |
                                  REG_G2S_DB_BG0CNT_MOSAIC_MASK)) |
            (screenSize << REG_G2S_DB_BG0CNT_SCREENSIZE_SHIFT) |
            (colorMode << REG_G2S_DB_BG0CNT_COLORMODE_SHIFT) |
            (screenBase << REG_G2S_DB_BG0CNT_SCREENBASE_SHIFT) |
            (charBase << REG_G2S_DB_BG0CNT_CHARBASE_SHIFT) |
...
static inline void G2_SetBG1Control(GXBGScrSizeText screenSize,
  ...
  reg_G2_BG1CNT = (u16)((reg_G2_BG1CNT & (REG_G2_BG1CNT_PRIORITY_MASK |
                                          REG_G2_BG1CNT_MOSAIC_MASK)) |
                        (screenSize << REG_G2_BG1CNT_SCREENSIZE_SHIFT) |
                        (colorMode << REG_G2_BG1CNT_COLORMODE_SHIFT) |
                        (screenBase << REG_G2_BG1CNT_SCREENBASE_SHIFT) |
                        (charBase << REG_G2_BG1CNT_CHARBASE_SHIFT) |
...
static inline void G2S_SetBG1Control(GXBGScrSizeText screenSize,
  ...
  reg_G2S_DB_BG1CNT =
      (u16)((reg_G2S_DB_BG1CNT & (REG_G2S_DB_BG1CNT_PRIORITY_MASK |
                                  REG_G2S_DB_BG1CNT_MOSAIC_MASK)) |
            (screenSize << REG_G2S_DB_BG1CNT_SCREENSIZE_SHIFT) |
            (colorMode << REG_G2S_DB_BG1CNT_COLORMODE_SHIFT) |
            (screenBase << REG_G2S_DB_BG1CNT_SCREENBASE_SHIFT) |
            (charBase << REG_G2S_DB_BG1CNT_CHARBASE_SHIFT) |
...
static inline GXBGExtMode G2S_GetBG2ExtMode(void) {
  ...
  return (
      GXBGExtMode)(reg_G2S_DB_BG2CNT &
                   (((reg_G2S_DB_BG2CNT & REG_G2S_DB_BG2CNT_COLORMODE_MASK) >>
                     5) |
...
static inline void G2_SetBG2ControlText(GXBGScrSizeText screenSize,
  ...
  reg_G2_BG2CNT = (u16)((reg_G2_BG2CNT & (REG_G2_BG2CNT_PRIORITY_MASK |
                        ...
                        (colorMode << REG_G2_BG2CNT_COLORMODE_SHIFT) |
...
static inline void G2S_SetBG2ControlText(GXBGScrSizeText screenSize,
  ...
  reg_G2S_DB_BG2CNT =
      (u16)((reg_G2S_DB_BG2CNT & (REG_G2S_DB_BG2CNT_PRIORITY_MASK |
                                  REG_G2S_DB_BG2CNT_MOSAIC_MASK)) |
            (screenSize << REG_G2S_DB_BG2CNT_SCREENSIZE_SHIFT) |
            (colorMode << REG_G2S_DB_BG2CNT_COLORMODE_SHIFT) |
            (screenBase << REG_G2S_DB_BG2CNT_SCREENBASE_SHIFT) |
...
static inline void
G2_SetBG2Control256x16Affine(GXBGScrSize256x16Pltt screenSize,
                             GXBGAreaOver areaOver, GXBGScrBase screenBase,
                             GXBGCharBase charBase) {
...
static inline void
G2S_SetBG2Control256x16Affine(GXBGScrSize256x16Pltt screenSize,
                              GXBGAreaOver areaOver, GXBGScrBase screenBase,
                              GXBGCharBase charBase) {
  GX_BG_SCRSIZE_256x16PLTT_ASSERT(screenSize);
  GX_BG_AREAOVER_ASSERT(areaOver);
...
static inline GXBGExtMode G2S_GetBG3ExtMode(void) {
  ...
  return (
      GXBGExtMode)(reg_G2S_DB_BG3CNT &
                   (((reg_G2S_DB_BG3CNT & REG_G2S_DB_BG3CNT_COLORMODE_MASK) >>
                     5) |
...
static inline void G2_SetBG3ControlText(GXBGScrSizeText screenSize,
  ...
  reg_G2_BG3CNT = (u16)((reg_G2_BG3CNT & (REG_G2_BG3CNT_PRIORITY_MASK |
                                          REG_G2_BG3CNT_MOSAIC_MASK)) |
                        (screenSize << REG_G2_BG3CNT_SCREENSIZE_SHIFT) |
                        (colorMode << REG_G2_BG3CNT_COLORMODE_SHIFT) |
                        (screenBase << REG_G2_BG3CNT_SCREENBASE_SHIFT) |
                        (charBase << REG_G2_BG3CNT_CHARBASE_SHIFT));
}
...
static inline void G2S_SetBG3ControlText(GXBGScrSizeText screenSize,
  ...
  reg_G2S_DB_BG3CNT =
      (u16)((reg_G2S_DB_BG3CNT & (REG_G2S_DB_BG3CNT_PRIORITY_MASK |
                                  REG_G2S_DB_BG3CNT_MOSAIC_MASK)) |
            (screenSize << REG_G2S_DB_BG3CNT_SCREENSIZE_SHIFT) |
            (colorMode << REG_G2S_DB_BG3CNT_COLORMODE_SHIFT) |
            (screenBase << REG_G2S_DB_BG3CNT_SCREENBASE_SHIFT) |
...
static inline void
G2_SetBG3Control256x16Affine(GXBGScrSize256x16Pltt screenSize,
                             GXBGAreaOver areaOver, GXBGScrBase screenBase,
                             GXBGCharBase charBase) {
  GX_BG_SCRSIZE_256x16PLTT_ASSERT(screenSize);
  GX_BG_AREAOVER_ASSERT(areaOver);
...
static inline void
G2S_SetBG3Control256x16Affine(GXBGScrSize256x16Pltt screenSize,
                              GXBGAreaOver areaOver, GXBGScrBase screenBase,
                              GXBGCharBase charBase) {
  GX_BG_SCRSIZE_256x16PLTT_ASSERT(screenSize);
  GX_BG_AREAOVER_ASSERT(areaOver);
...
static inline void *G2_GetOBJCharPtr() { return (void *)HW_OBJ_VRAM; }

static inline void *G2S_GetOBJCharPtr() { return (void *)HW_DB_OBJ_VRAM; }
