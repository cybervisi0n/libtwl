...
typedef enum {
  ...
  GX_VRAM_BG_16_F =
      GX_VRAM_F, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_F_SIZE
  GX_VRAM_BG_16_G =
      GX_VRAM_G, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_G_SIZE
  GX_VRAM_BG_32_FG = GX_VRAM_F | GX_VRAM_G, // ARM9: HW_BG_VRAM   --> HW_BG_VRAM
                                            // + HW_VRAM_F_SIZE + HW_VRAM_G_SIZE
  GX_VRAM_BG_64_E =
      GX_VRAM_E, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_E_SIZE
  GX_VRAM_BG_80_EF = GX_VRAM_E | GX_VRAM_F, // ARM9: HW_BG_VRAM   --> HW_BG_VRAM
                                            // + HW_VRAM_E_SIZE + HW_VRAM_F_SIZE
  GX_VRAM_BG_96_EFG =
      GX_VRAM_E | GX_VRAM_F |
      GX_VRAM_G, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_E_SIZE +
                 // HW_VRAM_F_SIZE + HW_VRAM_G_SIZE
  GX_VRAM_BG_128_A =
      GX_VRAM_A, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_A_SIZE
  GX_VRAM_BG_128_B =
      GX_VRAM_B, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_B_SIZE
  GX_VRAM_BG_128_C =
      GX_VRAM_C, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_C_SIZE
  GX_VRAM_BG_128_D =
      GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_D_SIZE
  GX_VRAM_BG_256_AB =
      GX_VRAM_A | GX_VRAM_B, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_A_SIZE + HW_VRAM_B_SIZE
  GX_VRAM_BG_256_BC =
      GX_VRAM_B | GX_VRAM_C, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_B_SIZE + HW_VRAM_C_SIZE
  GX_VRAM_BG_256_CD =
      GX_VRAM_C | GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_C_SIZE + HW_VRAM_D_SIZE
  GX_VRAM_BG_384_ABC =
      GX_VRAM_A | GX_VRAM_B |
      GX_VRAM_C, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_A_SIZE +
                 // HW_VRAM_B_SIZE + HW_VRAM_C_SIZE
  GX_VRAM_BG_384_BCD =
      GX_VRAM_B | GX_VRAM_C |
      GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_B_SIZE +
                 // HW_VRAM_C_SIZE + HW_VRAM_D_SIZE
  GX_VRAM_BG_512_ABCD =
      GX_VRAM_A | GX_VRAM_B | GX_VRAM_C |
      GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_A_SIZE +
                 // HW_VRAM_B_SIZE + HW_VRAM_C_SIZE + HW_VRAM_D_SIZE

  GX_VRAM_BG_80_EG = GX_VRAM_E | GX_VRAM_G, // ARM9: HW_BG_VRAM   --> HW_BG_VRAM
                                            // + HW_VRAM_E_SIZE + HW_VRAM_G_SIZE
  GX_VRAM_BG_256_AC =
      GX_VRAM_A | GX_VRAM_C, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_A_SIZE + HW_VRAM_C_SIZE
  GX_VRAM_BG_256_AD =
      GX_VRAM_A | GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_A_SIZE + HW_VRAM_D_SIZE
  GX_VRAM_BG_256_BD =
      GX_VRAM_B | GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM +
                             // HW_VRAM_B_SIZE + HW_VRAM_D_SIZE
  GX_VRAM_BG_384_ABD =
      GX_VRAM_A | GX_VRAM_B |
      GX_VRAM_D, // ARM9: HW_BG_VRAM   -->   HW_BG_VRAM + HW_VRAM_A_SIZE +
                 // HW_VRAM_B_SIZE + HW_VRAM_D_SIZE
...
#define GX_VRAM_BG_ASSERT(x)                                                   \
  SDK_ASSERT((x) == GX_VRAM_BG_NONE || (x) == GX_VRAM_BG_16_F ||               \
             (x) == GX_VRAM_BG_16_G || (x) == GX_VRAM_BG_32_FG ||              \
             (x) == GX_VRAM_BG_64_E || (x) == GX_VRAM_BG_80_EF ||              \
             (x) == GX_VRAM_BG_80_EG || (x) == GX_VRAM_BG_96_EFG ||            \
             (x) == GX_VRAM_BG_128_A || (x) == GX_VRAM_BG_128_B ||             \
             (x) == GX_VRAM_BG_128_C || (x) == GX_VRAM_BG_128_D ||             \
             (x) == GX_VRAM_BG_256_AB || (x) == GX_VRAM_BG_256_BC ||           \
             (x) == GX_VRAM_BG_256_CD || (x) == GX_VRAM_BG_384_ABC ||          \
             (x) == GX_VRAM_BG_384_BCD || (x) == GX_VRAM_BG_512_ABCD ||        \
             (x) == GX_VRAM_BG_256_AC || (x) == GX_VRAM_BG_256_AD ||           \
             (x) == GX_VRAM_BG_256_BD || (x) == GX_VRAM_BG_384_ABD ||          \
             (x) == GX_VRAM_BG_384_ACD)

#define GX_VRAM_BG_ASSERT_EX_1(x)                                              \
  SDK_ASSERT((x) == GX_VRAM_BG_16_F || (x) == GX_VRAM_BG_16_G ||               \
             (x) == GX_VRAM_BG_32_FG || (x) == GX_VRAM_BG_64_E ||              \
             (x) == GX_VRAM_BG_80_EF || (x) == GX_VRAM_BG_80_EG ||             \
             (x) == GX_VRAM_BG_96_EFG)

#define GX_VRAM_BG_ASSERT_EX_2(x)                                              \
  SDK_ASSERT((x) == GX_VRAM_BG_NONE || (x) == GX_VRAM_BG_128_A ||              \
             (x) == GX_VRAM_BG_128_B || (x) == GX_VRAM_BG_128_C ||             \
             (x) == GX_VRAM_BG_128_D || (x) == GX_VRAM_BG_256_AB ||            \
             (x) == GX_VRAM_BG_256_BC || (x) == GX_VRAM_BG_256_CD ||           \
             (x) == GX_VRAM_BG_384_ABC || (x) == GX_VRAM_BG_384_BCD ||         \
             (x) == GX_VRAM_BG_256_AC || (x) == GX_VRAM_BG_256_AD ||           \
             (x) == GX_VRAM_BG_256_BD || (x) == GX_VRAM_BG_384_ABD ||          \
             (x) == GX_VRAM_BG_384_ACD)
...
typedef enum {
  ...
  GX_VRAM_OBJ_16_F =
      GX_VRAM_F, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_F_SIZE
  GX_VRAM_OBJ_16_G =
      GX_VRAM_G, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_G_SIZE
  GX_VRAM_OBJ_32_FG =
      GX_VRAM_F | GX_VRAM_G, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM +
                             // HW_VRAM_F_SIZE + HW_VRAM_G_SIZE
  GX_VRAM_OBJ_64_E =
      GX_VRAM_E, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_E_SIZE
  GX_VRAM_OBJ_80_EF =
      GX_VRAM_E | GX_VRAM_F, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM +
                             // HW_VRAM_E_SIZE + HW_VRAM_F_SIZE
  GX_VRAM_OBJ_80_EG =
  ...
  GX_VRAM_OBJ_96_EFG =
      GX_VRAM_E | GX_VRAM_F |
      GX_VRAM_G, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_E_SIZE +
                 // HW_VRAM_F_SIZE + HW_VRAM_G_SIZE
  GX_VRAM_OBJ_128_A =
      GX_VRAM_A, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_A_SIZE
  GX_VRAM_OBJ_128_B =
      GX_VRAM_B, // ARM9: HW_OBJ_VRAM  -->   HW_OBJ_VRAM + HW_VRAM_B_SIZE
  GX_VRAM_OBJ_256_AB =
...
#define GX_VRAM_OBJ_ASSERT(x)                                                  \
  SDK_ASSERT((x) == GX_VRAM_OBJ_NONE || (x) == GX_VRAM_OBJ_16_F ||             \
             (x) == GX_VRAM_OBJ_16_G || (x) == GX_VRAM_OBJ_32_FG ||            \
             (x) == GX_VRAM_OBJ_64_E || (x) == GX_VRAM_OBJ_80_EF ||            \
             (x) == GX_VRAM_OBJ_80_EG || (x) == GX_VRAM_OBJ_96_EFG ||          \
             (x) == GX_VRAM_OBJ_128_A || (x) == GX_VRAM_OBJ_128_B ||           \
...
typedef enum {
  ...
  GX_VRAM_ARM7_256_CD =
      GX_VRAM_C | GX_VRAM_D // ARM7: 0x06000000   -->   0x06040000
} GXVRamARM7;

#define GX_VRAM_ARM7_ASSERT(x)                                                 \
  SDK_ASSERT((x) == GX_VRAM_ARM7_NONE || (x) == GX_VRAM_ARM7_128_C ||          \
             (x) == GX_VRAM_ARM7_128_D || (x) == GX_VRAM_ARM7_256_CD)
...
typedef enum {
  ...
  GX_VRAM_TEX_012_ABC =
      GX_VRAM_A | GX_VRAM_B | GX_VRAM_C, // TextureImageSlot 012
  GX_VRAM_TEX_012_BCD =
      GX_VRAM_B | GX_VRAM_C | GX_VRAM_D, // TextureImageSlot 012
  GX_VRAM_TEX_0123_ABCD =
      GX_VRAM_A | GX_VRAM_B | GX_VRAM_C | GX_VRAM_D, // TextureImageSlot 0123
  ...
  GX_VRAM_TEX_012_ABD =
      GX_VRAM_A | GX_VRAM_B | GX_VRAM_D, // TextureImageSlot 012
  GX_VRAM_TEX_012_ACD =
      GX_VRAM_A | GX_VRAM_C | GX_VRAM_D // TextureImageSlot 012
} GXVRamTex;

#define GX_VRAM_TEX_ASSERT(x)                                                  \
  SDK_ASSERT((x) == GX_VRAM_TEX_NONE || (x) == GX_VRAM_TEX_0_A ||              \
             (x) == GX_VRAM_TEX_0_B || (x) == GX_VRAM_TEX_0_C ||               \
             (x) == GX_VRAM_TEX_0_D || (x) == GX_VRAM_TEX_01_AB ||             \
             (x) == GX_VRAM_TEX_01_BC || (x) == GX_VRAM_TEX_01_CD ||           \
             (x) == GX_VRAM_TEX_012_ABC || (x) == GX_VRAM_TEX_012_BCD ||       \
             (x) == GX_VRAM_TEX_0123_ABCD || (x) == GX_VRAM_TEX_01_AC ||       \
             (x) == GX_VRAM_TEX_01_AD || (x) == GX_VRAM_TEX_01_BD ||           \
             (x) == GX_VRAM_TEX_012_ABD || (x) == GX_VRAM_TEX_012_ACD)
...
#define GX_VRAM_CLRIMG_ASSERT(x)                                               \
  SDK_ASSERT(                                                                  \
      (x) == GX_VRAM_CLEARIMAGE_NONE || (x) == GX_VRAM_CLEARIMAGE_256_AB ||    \
      (x) == GX_VRAM_CLEARIMAGE_256_CD || (x) == GX_VRAM_CLEARDEPTH_128_A ||   \
      (x) == GX_VRAM_CLEARDEPTH_128_B || (x) == GX_VRAM_CLEARDEPTH_128_C ||    \
...
typedef enum {
  ...
  GX_VRAM_TEXPLTT_012345_EFG =
      GX_VRAM_E | GX_VRAM_F | GX_VRAM_G // TexturePltt 0-3,45
} GXVRamTexPltt;

#define GX_VRAM_TEXPLTT_ASSERT(x)                                              \
  SDK_ASSERT((x) == GX_VRAM_TEXPLTT_NONE || (x) == GX_VRAM_TEXPLTT_0_F ||      \
             (x) == GX_VRAM_TEXPLTT_0_G || (x) == GX_VRAM_TEXPLTT_01_FG ||     \
...
#define GX_VRAM_BGEXTPLTT_ASSERT(x)                                            \
  SDK_ASSERT((x) == GX_VRAM_BGEXTPLTT_NONE || (x) == GX_VRAM_BGEXTPLTT_01_F || \
...
#define GX_VRAM_OBJEXTPLTT_ASSERT(x)                                           \
  SDK_ASSERT((x) == GX_VRAM_OBJEXTPLTT_NONE ||                                 \
             (x) == GX_VRAM_OBJEXTPLTT_0_F || (x) == GX_VRAM_OBJEXTPLTT_0_G)
...
#define GX_VRAM_SUB_BG_ASSERT(x)                                               \
  SDK_ASSERT((x) == GX_VRAM_SUB_BG_NONE || (x) == GX_VRAM_SUB_BG_128_C ||      \
             (x) == GX_VRAM_SUB_BG_32_H || (x) == GX_VRAM_SUB_BG_48_HI)
...
#define GX_VRAM_SUB_OBJ_ASSERT(x)                                              \
  SDK_ASSERT((x) == GX_VRAM_SUB_OBJ_NONE || (x) == GX_VRAM_SUB_OBJ_128_D ||    \
