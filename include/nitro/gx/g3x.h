...
typedef enum { GX_FOGBLEND_COLOR_ALPHA = 0, GX_FOGBLEND_ALPHA = 1 } GXFogBlend;
...
void G3X_SetFog(BOOL enable, GXFogBlend fogMode, GXFogSlope fogSlope,
                int fogOffset);
...
int G3X_GetPositionTestResult(
    VecFx32 *vec, fx32 *w); // read: GXSTAT(0), POS_RESULT_X, POS_RESULT_Y,
                            // POS_RESULT_Z, POS_RESULT_W
int G3X_GetVectorTestResult(
    fx16 *vec); // read: GXSTAT(0), VEC_RESULT_X, VEC_RESULT_Y, VEC_RESULT_Z
...
void G3X_SetClearColor(GXRgb rgb, int alpha, int depth, int polygonID,
                       BOOL fog);
...
static inline void G3X_AlphaTest(BOOL enable, int ref) {
  if (enable) {
    ...
    reg_G3X_DISP3DCNT &=
        (u16) ~(REG_G3X_DISP3DCNT_ATE_MASK | REG_G3X_DISP3DCNT_RO_MASK |
                REG_G3X_DISP3DCNT_GO_MASK);
  }
}
...
static inline void G3X_AlphaBlend(BOOL enable) {
  if (enable) {
    ...
    reg_G3X_DISP3DCNT &=
        (u16) ~(REG_G3X_DISP3DCNT_ABE_MASK | REG_G3X_DISP3DCNT_RO_MASK |
                REG_G3X_DISP3DCNT_GO_MASK);
  }
}
...
static inline void G3X_AntiAlias(BOOL enable) {
  if (enable) {
    ...
    reg_G3X_DISP3DCNT &=
        (u16) ~(REG_G3X_DISP3DCNT_AAE_MASK | REG_G3X_DISP3DCNT_RO_MASK |
                REG_G3X_DISP3DCNT_GO_MASK);
  }
}
...
static inline void G3X_EdgeMarking(BOOL enable) {
  if (enable) {
    ...
    reg_G3X_DISP3DCNT &=
        (u16) ~(REG_G3X_DISP3DCNT_EME_MASK | REG_G3X_DISP3DCNT_RO_MASK |
                REG_G3X_DISP3DCNT_GO_MASK);
  }
}
...
static inline void G3X_SetClearImageOffset(int xOffset, int yOffset) {
  reg_G3X_CLRIMAGE_OFFSET =
      (u16)(((xOffset << REG_G3X_CLRIMAGE_OFFSET_OFFSETX_SHIFT) &
             REG_G3X_CLRIMAGE_OFFSET_OFFSETX_MASK) |
            ((yOffset << REG_G3X_CLRIMAGE_OFFSET_OFFSETY_SHIFT) &
...
static inline s32 G3X_GetVtxListRamCount(void) { return reg_G3X_VTXRAM_COUNT; }
...
static inline s32 G3X_GetCommandFifoCount(void) {
  return (s32)((reg_G3X_GXSTAT & REG_G3X_GXSTAT_FIFOCNT_MASK) >>
               REG_G3X_GXSTAT_FIFOCNT_SHIFT);
}

static inline GXFifoStat G3X_GetCommandFifoStatus(void) {
  return (GXFifoStat)((reg_G3X_GXSTAT &
                       (REG_G3X_GXSTAT_F_MASK | REG_G3X_GXSTAT_H_MASK |
                        REG_G3X_GXSTAT_E_MASK)) >>
                      REG_G3X_GXSTAT_F_SHIFT);
}
