...
#define GX_RGB(r, g, b)                                                        \
  ((GXRgb)(((r) << GX_RGB_R_SHIFT) | ((g) << GX_RGB_G_SHIFT) |                 \
           ((b) << GX_RGB_B_SHIFT)))
...
#define GX_RGBA(r, g, b, a)                                                    \
  ((GXRgba)(((r) << GX_RGBA_R_SHIFT) | ((g) << GX_RGBA_G_SHIFT) |              \
            ((b) << GX_RGBA_B_SHIFT) | ((a) << GX_RGBA_A_SHIFT)))
...
#define GX_VECFX10(x, y, z)                                                    \
  ((VecFx10)(((((x) >> (FX32_DEC_SIZE - GX_FX10_DEC_SIZE)) & GX_FX10_MASK)     \
              << GX_VEC_FX10_X_SHIFT) |                                        \
             ((((y) >> (FX32_DEC_SIZE - GX_FX10_DEC_SIZE)) & GX_FX10_MASK)     \
              << GX_VEC_FX10_Y_SHIFT) |                                        \
             ((((z) >> (FX32_DEC_SIZE - GX_FX10_DEC_SIZE)) & GX_FX10_MASK)     \
              << GX_VEC_FX10_Z_SHIFT)))
