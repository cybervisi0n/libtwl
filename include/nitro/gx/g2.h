...
#define GX_WND_PLANEMASK_ASSERT(x)                                             \
  SDK_MINMAX_ASSERT(x, GX_WND_PLANEMASK_NONE,                                  \
...
static void G2_SetBG2Affine(const MtxFx22 *mtx, int centerX, int centerY,
                            int x1, int y1);
static void G2_SetBG3Affine(const MtxFx22 *mtx, int centerX, int centerY,
                            int x1, int y1);
...
static void G2S_SetBG2Affine(const MtxFx22 *mtx, int centerX, int centerY,
                             int x1, int y1);
static void G2S_SetBG3Affine(const MtxFx22 *mtx, int centerX, int centerY,
                             int x1, int y1);
...
void G2x_SetBGyAffine_(u32 addr, const MtxFx22 *mtx, int centerX, int centerY,
                       int x1, int y1);
...
void G2x_SetBlendBrightnessExt_(u32 addr, int plane1, int plane2, int ev1,
...
static inline void G2_SetBG0Offset(int hOffset, int vOffset) {
  ...
  reg_G2_BG0OFS = (u32)(((hOffset << REG_G2_BG0OFS_HOFFSET_SHIFT) &
                         REG_G2_BG0OFS_HOFFSET_MASK) |
                        ((vOffset << REG_G2_BG0OFS_VOFFSET_SHIFT) &
                         REG_G2_BG0OFS_VOFFSET_MASK));
}

static inline void G2_SetBG1Offset(int hOffset, int vOffset) {
  reg_G2_BG1OFS = (u32)(((hOffset << REG_G2_BG1OFS_HOFFSET_SHIFT) &
                         REG_G2_BG1OFS_HOFFSET_MASK) |
                        ((vOffset << REG_G2_BG1OFS_VOFFSET_SHIFT) &
                         REG_G2_BG1OFS_VOFFSET_MASK));
}

static inline void G2_SetBG2Offset(int hOffset, int vOffset) {
#ifdef SDK_DEBUG
  {
    u32 tmp = (reg_GX_DISPCNT & REG_GX_DISPCNT_BGMODE_MASK) >>
              REG_GX_DISPCNT_BGMODE_SHIFT;
    SDK_WARNING((0 == tmp) || (1 == tmp) || (3 == tmp),
                "G2_SetBG2Offset requires BG #2 to be text mode. Use "
                "G2_SetBG2Affine instead.");
  }
#endif
  reg_G2_BG2OFS = (u32)(((hOffset << REG_G2_BG2OFS_HOFFSET_SHIFT) &
                         REG_G2_BG2OFS_HOFFSET_MASK) |
                        ((vOffset << REG_G2_BG2OFS_VOFFSET_SHIFT) &
                         REG_G2_BG2OFS_VOFFSET_MASK));
}
...
static inline void G2_SetBG3Offset(int hOffset, int vOffset) {
#ifdef SDK_DEBUG
  {
    u32 tmp = (reg_GX_DISPCNT & REG_GX_DISPCNT_BGMODE_MASK) >>
              REG_GX_DISPCNT_BGMODE_SHIFT;
    SDK_WARNING(0 == tmp, "G2_SetBG3Offset requires BG #3 to be text mode. Use "
                          "G2_SetBG3Affine instead.");
  }
#endif
  reg_G2_BG3OFS = (u32)(((hOffset << REG_G2_BG3OFS_HOFFSET_SHIFT) &
                         REG_G2_BG3OFS_HOFFSET_MASK) |
                        ((vOffset << REG_G2_BG3OFS_VOFFSET_SHIFT) &
                         REG_G2_BG3OFS_VOFFSET_MASK));
}
...
static inline void G2_SetWnd0InsidePlane(int wnd, BOOL effect) {
  ...
  tmp = ((reg_G2_WININ & ~REG_G2_WININ_WIN0IN_MASK) |
         ((u32)wnd << REG_G2_WININ_WIN0IN_SHIFT));
...
static inline void G2_SetWnd1InsidePlane(int wnd, BOOL effect) {
  ...
  tmp = ((reg_G2_WININ & ~REG_G2_WININ_WIN1IN_MASK) |
         ((u32)wnd << REG_G2_WININ_WIN1IN_SHIFT));
...
static inline void G2_SetWndOutsidePlane(int wnd, BOOL effect) {
  ...
  tmp = ((reg_G2_WINOUT & ~REG_G2_WINOUT_WINOUT_MASK) |
         ((u32)wnd << REG_G2_WINOUT_WINOUT_SHIFT));
...
static inline void G2_SetWnd0Position(int x1, int y1, int x2, int y2) {
  ...
  reg_G2_WIN0H =
      (u16)(((x1 << REG_G2_WIN0H_LEFTX_SHIFT) & REG_G2_WIN0H_LEFTX_MASK) |
            ((x2 << REG_G2_WIN0H_RIGHTX_SHIFT) & REG_G2_WIN0H_RIGHTX_MASK));

  reg_G2_WIN0V =
      (u16)(((y1 << REG_G2_WIN0V_UPY_SHIFT) & REG_G2_WIN0V_UPY_MASK) |
...
static inline void G2_SetWnd1Position(int x1, int y1, int x2, int y2) {
  ...
  reg_G2_WIN1H =
      (u16)(((x1 << REG_G2_WIN1H_LEFTX_SHIFT) & REG_G2_WIN1H_LEFTX_MASK) |
            ((x2 << REG_G2_WIN1H_RIGHTX_SHIFT) & REG_G2_WIN1H_RIGHTX_MASK));

  reg_G2_WIN1V =
      (u16)(((y1 << REG_G2_WIN1V_UPY_SHIFT) & REG_G2_WIN1V_UPY_MASK) |
...
static inline void G2_SetOBJMosaicSize(int hSize, int vSize) {
  ...
  *((vu8 *)(REG_MOSAIC_ADDR + 1)) =
      (u8)((hSize << (REG_G2_MOSAIC_OBJHSIZE_SHIFT - 8)) |
           (vSize << (REG_G2_MOSAIC_OBJVSIZE_SHIFT - 8)));
}

static inline void G2_BlendNone() { reg_G2_BLDCNT = 0; }
...
static inline void G2S_SetBG0Offset(int hOffset, int vOffset) {
  reg_G2S_DB_BG0OFS = (u32)(((hOffset << REG_G2S_DB_BG0OFS_HOFFSET_SHIFT) &
                             REG_G2S_DB_BG0OFS_HOFFSET_MASK) |
                            ((vOffset << REG_G2S_DB_BG0OFS_VOFFSET_SHIFT) &
                             REG_G2S_DB_BG0OFS_VOFFSET_MASK));
}

static inline void G2S_SetBG1Offset(int hOffset, int vOffset) {
  reg_G2S_DB_BG1OFS = (u32)(((hOffset << REG_G2S_DB_BG1OFS_HOFFSET_SHIFT) &
                             REG_G2S_DB_BG1OFS_HOFFSET_MASK) |
                            ((vOffset << REG_G2S_DB_BG1OFS_VOFFSET_SHIFT) &
                             REG_G2S_DB_BG1OFS_VOFFSET_MASK));
}

static inline void G2S_SetBG2Offset(int hOffset, int vOffset) {
#ifdef SDK_DEBUG
  {
    u32 tmp = (reg_GXS_DB_DISPCNT & REG_GXS_DB_DISPCNT_BGMODE_MASK) >>
              REG_GXS_DB_DISPCNT_BGMODE_SHIFT;
    SDK_WARNING((0 == tmp) || (1 == tmp) || (3 == tmp),
                "G2S_SetBG2Offset requires BG #2 to be text mode. Use "
                "G2S_SetBG2Affine instead.");
  }
#endif

  reg_G2S_DB_BG2OFS = (u32)(((hOffset << REG_G2S_DB_BG2OFS_HOFFSET_SHIFT) &
                             REG_G2S_DB_BG2OFS_HOFFSET_MASK) |
                            ((vOffset << REG_G2S_DB_BG2OFS_VOFFSET_SHIFT) &
                             REG_G2S_DB_BG2OFS_VOFFSET_MASK));
}
...
static inline void G2S_SetBG3Offset(int hOffset, int vOffset) {
#ifdef SDK_DEBUG
  {
    u32 tmp = (reg_GXS_DB_DISPCNT & REG_GXS_DB_DISPCNT_BGMODE_MASK) >>
              REG_GXS_DB_DISPCNT_BGMODE_SHIFT;
    SDK_WARNING(0 == tmp, "G2S_SetBG3Offset requires BG #3 to be text mode. "
                          "Use G2S_SetBG3Affine instead.");
  }
#endif

  reg_G2S_DB_BG3OFS = (u32)(((hOffset << REG_G2S_DB_BG3OFS_HOFFSET_SHIFT) &
                             REG_G2S_DB_BG3OFS_HOFFSET_MASK) |
                            ((vOffset << REG_G2S_DB_BG3OFS_VOFFSET_SHIFT) &
                             REG_G2S_DB_BG3OFS_VOFFSET_MASK));
}
...
static inline void G2S_SetWnd0Position(int x1, int y1, int x2, int y2) {
  ...
  reg_G2S_DB_WIN0H = (u16)(((x1 << REG_G2S_DB_WIN0H_LEFTX_SHIFT) &
                            REG_G2S_DB_WIN0H_LEFTX_MASK) |
                           ((x2 << REG_G2S_DB_WIN0H_RIGHTX_SHIFT) &
                            REG_G2S_DB_WIN0H_RIGHTX_MASK));

  reg_G2S_DB_WIN0V =
      (u16)(((y1 << REG_G2S_DB_WIN0V_UPY_SHIFT) & REG_G2S_DB_WIN0V_UPY_MASK) |
            ((y2 << REG_G2S_DB_WIN0V_DOWNY_SHIFT) &
             REG_G2S_DB_WIN0V_DOWNY_MASK));
}
...
static inline void G2S_SetWnd1Position(int x1, int y1, int x2, int y2) {
  ...
  reg_G2S_DB_WIN1H = (u16)(((x1 << REG_G2S_DB_WIN1H_LEFTX_SHIFT) &
                            REG_G2S_DB_WIN1H_LEFTX_MASK) |
                           ((x2 << REG_G2S_DB_WIN1H_RIGHTX_SHIFT) &
                            REG_G2S_DB_WIN1H_RIGHTX_MASK));

  reg_G2S_DB_WIN1V =
      (u16)(((y1 << REG_G2S_DB_WIN1V_UPY_SHIFT) & REG_G2S_DB_WIN1V_UPY_MASK) |
            ((y2 << REG_G2S_DB_WIN1V_DOWNY_SHIFT) &
             REG_G2S_DB_WIN1V_DOWNY_MASK));
}
...
static inline void G2S_SetBGMosaicSize(int hSize, int vSize) {
  ...
  *((vu8 *)REG_DB_MOSAIC_ADDR) =
      (u8)((hSize << REG_G2S_DB_MOSAIC_BGHSIZE_SHIFT) |
...
static inline void G2S_SetOBJMosaicSize(int hSize, int vSize) {
  ...
  *((vu8 *)(REG_DB_MOSAIC_ADDR + 1)) =
      (u8)((hSize << (REG_G2S_DB_MOSAIC_OBJHSIZE_SHIFT - 8)) |
           (vSize << (REG_G2S_DB_MOSAIC_OBJVSIZE_SHIFT - 8)));
}

static inline void G2S_BlendNone() { reg_G2S_DB_BLDCNT = 0; }
