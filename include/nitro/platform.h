...
#define PLATFORM_ENTER_CRITICALSECTION()                                       \
  OSIntrMode bak_interrupt_mode_ = OS_DisableInterrupts()

#define PLATFORM_LEAVE_CRITICALSECTION()                                       \
  (void)OS_RestoreInterrupts(bak_interrupt_mode_)
